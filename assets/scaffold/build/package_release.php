...
$releaseMetadata = \Autoborna\CoreBundle\Release\ThisRelease::getMetadata();
...
if (!isset($args['repackage'])) {
    ...
    // Compile prod assets
    system('cd '.__DIR__.'/packaging && php '.__DIR__.'/packaging/bin/console autoborna:assets:generate -e prod', $result);
    if (0 !== $result) {
        exit;
    }
    ...
    $assetFiles = [
        ...
        'media/js/autoborna-form.js' => true,
    ];
...
echo "Packaging Autoborna Full Installation\n";
