...
namespace Autoborna\ApiBundle\Model;

use Autoborna\ApiBundle\ApiEvents;
use Autoborna\ApiBundle\Entity\oAuth2\Client;
use Autoborna\ApiBundle\Event\ClientEvent;
use Autoborna\ApiBundle\Form\Type\ClientType;
...
class ClientModel extends FormModel
{
    ...
    public function __construct(RequestStack $requestStack)
    {
        ...
        if ($request) {
            $this->apiMode = $request->get('api_mode', $request->getSession()->get('autoborna.client.filter.api_mode', 'oauth2'));
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getRepository(): \Autoborna\ApiBundle\Entity\oAuth2\ClientRepository
    {
