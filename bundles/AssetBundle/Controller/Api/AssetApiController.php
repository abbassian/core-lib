...
namespace Autoborna\AssetBundle\Controller\Api;
...
class AssetApiController extends CommonApiController
{
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->entityClass      = 'Autoborna\AssetBundle\Entity\Asset';
    ...
    {
        $assetDir = $this->get('autoborna.helper.core_parameters')->get('upload_dir');
