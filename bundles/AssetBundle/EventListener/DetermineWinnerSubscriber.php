    ...
    public function onDetermineDownloadRateWinner(DetermineWinnerEvent $event)
    {
        ...
        if (null != $startDate && !empty($ids)) {
            ...
            if ($counts) {
                ...
                $downloadsLabel = $translator->trans('autoborna.asset.abtest.label.downloads');
                $hitsLabel      = ('page' == $type) ? $translator->trans('autoborna.asset.abtest.label.hits') : $translator->trans('autoborna.asset.abtest.label.sentemils');
