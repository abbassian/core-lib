...
namespace Autoborna\AssetBundle\Model;
...
use Autoborna\AssetBundle\Event\AssetEvent;
use Autoborna\AssetBundle\Event\AssetLoadEvent;
use Autoborna\AssetBundle\Form\Type\AssetType;
...
class AssetModel extends FormModel
{
        ...
        if (empty($systemEntry)) {
            ...
            if (isset($systemEntry['email'])) {
                ...
                if (!$email instanceof Email) {
                    ...
                    $email   = $this->em->getReference('AutobornaEmailBundle:Email', $emailId);
                }
    ...
    /**
     * @return \Autoborna\AssetBundle\Entity\AssetRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('AutobornaAssetBundle:Asset');
    }

    /**
     * @return \Autoborna\AssetBundle\Entity\DownloadRepository
     */
    public function getDownloadRepository()
    {
        return $this->em->getRepository('AutobornaAssetBundle:Download');
    }
    ...
    public function getLookupResults($type, $filter = '', $limit = 10)
    {
        ...
        switch ($type) {
            case 'asset':
                ...
                if ('autoborna_segment_action' === $request->get('_route') &&
    ...
    public function generateUrl($entity, $absolute = true, $clickthrough = [])
    {
        ...
        return $this->buildUrl('autoborna_asset_download', $slugs, $absolute, $clickthrough);
    }
    ...
    public function getDownloadsLineChartData($unit, \DateTime $dateFrom, \DateTime $dateTo, $dateFormat = null, $filter = [], $canViewOthers = true)
    {
        ...
        $chart->setDataset($this->translator->trans('autoborna.asset.downloadcount'), $data);
    ...
    public function getUniqueVsRepetitivePieChartData($dateFrom, $dateTo, $filters = [], $canViewOthers = true)
    {
        ...
        $chart->setDataset($this->translator->trans('autoborna.asset.unique'), $unique);
        $chart->setDataset($this->translator->trans('autoborna.asset.repetitive'), $repetitive);
