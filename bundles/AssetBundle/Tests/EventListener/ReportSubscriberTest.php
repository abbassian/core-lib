...
namespace Autoborna\AssetBundle\Tests\EventListener;

use Autoborna\AssetBundle\Entity\DownloadRepository;
use Autoborna\AssetBundle\EventListener\ReportSubscriber;
    ...
    public function testOnReportBuilderWithAssetDownloadContext(): void
    {
        ...
        Assert::assertSame(
            [
                ...
                'label' => '[trans]autoborna.asset.report.download_count[/trans]',
                'type'  => 'int',
            ],
        ...
        Assert::assertSame(
            [
                ...
                'label' => '[trans]autoborna.asset.report.unique_download_count[/trans]',
                'type'  => 'int',
            ],
