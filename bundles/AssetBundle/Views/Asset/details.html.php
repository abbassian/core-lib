...
$view['slots']->set(
    'publishStatus',
    $view->render('AutobornaCoreBundle:Helper:publishstatus_badge.html.php', ['entity' => $activeAsset])
);
...
<div class="box-layout">
    ...
    <div class="col-md-9 bg-white height-auto">
                        ...
                        <table class="table table-bordered table-striped mb-0">
                            ...
                            <tr>
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans(
                                            'autoborna.asset.asset.size'
                                        ); ?></span></td>
                                <td><?php echo $activeAsset->getSize(); ?></td>
                            </tr>
                            <tr>
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans(
                                            'autoborna.asset.asset.path.relative'
                                        ); ?></span></td>
                                <td><?php echo $assetDownloadUrl; ?></td>
                            </tr>
                            <tr>
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans(
                                            'autoborna.asset.filename.original'
                                        ); ?></span></td>
                            ...
                            <tr>
                                ...
                                <td width="20%"><span class="fw-b textTitle"><?php echo $view['translator']->trans(
                                            'autoborna.asset.filename.'.$location
                                        ); ?></span></td>
                    ...
                    <div class="col-sm-12">
                        <div class="panel">
                            <div class="panel-body box-layout">
                                <div class="col-md-2 va-m">
                                    <h5 class="text-white dark-md fw-sb mb-xs">
                                        ...
                                        <?php echo $view['translator']->trans('autoborna.asset.graph.line.downloads'); ?>
                                    </h5>
                                </div>
                                <div class="col-md-2 va-m text-center">
                                    <span class="text-white dark-md fw-sb mb-xs"><?php echo $view['translator']->trans('autoborna.asset.asset.downloads.total', ['count' => $stats['downloads']['total']]); ?></span>
                                    <span class="text-white dark-md fw-sb mb-xs">|</span>
                                    <span class="text-white dark-md fw-sb mb-xs"><?php echo $view['translator']->trans('autoborna.asset.asset.downloads.unique', ['count' => $stats['downloads']['unique']]); ?></span>
                                </div>
                            ...
                            <div class="pt-0 pl-15 pb-10 pr-15">
                                <?php echo $view->render('AutobornaCoreBundle:Helper:chart.html.php', ['chartData' => $stats['downloads']['timeStats'], 'chartType' => 'line', 'chartHeight' => 300]); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-content pa-md preview-detail">
            <?php echo $view->render(
                'AutobornaAssetBundle:Asset:preview.html.php',
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mt-sm mb-0">
            <div class="panel-heading">
                <div class="panel-title"><?php echo $view['translator']->trans('autoborna.asset.asset.url'); ?></div>
            </div>
