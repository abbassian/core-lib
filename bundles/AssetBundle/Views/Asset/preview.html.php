...
<h5 class="fw-sb mb-xs"><?php echo $view['translator']->trans('autoborna.asset.asset.preview'); ?></h5>
<div class="text-center">
    ...
    <?php elseif (0 === strpos($activeAsset->getMime(), 'video') || in_array($activeAsset->getExtension(), ['mpg', 'mpeg', 'mp4', 'webm'])): ?>
        <video src="<?php echo $assetDownloadUrl.'?stream=1'; ?>" controls>
            <?php echo $view['translator']->trans('autoborna.asset.no_video_support'); ?>
        </video>
    <?php elseif (0 === strpos($activeAsset->getMime(), 'audio') || in_array($activeAsset->getExtension(), ['mp3', 'ogg', 'wav'])): ?>
        <audio controls>
            ...
            <?php echo $view['translator']->trans('autoborna.asset.no_audio_support'); ?>
        </audio>
    <?php else: ?>
