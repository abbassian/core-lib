...
use Autoborna\CampaignBundle\Event\CampaignTriggerEvent;
use Autoborna\CampaignBundle\Executioner\ContactFinder\Limiter\ContactLimiter;
use Autoborna\CampaignBundle\Executioner\InactiveExecutioner;
use Autoborna\CampaignBundle\Executioner\KickoffExecutioner;
use Autoborna\CampaignBundle\Executioner\ScheduledExecutioner;
...
class TriggerCampaignCommand extends ModeratedCommand
{
    ...
    {
        $this
            ->setName('autoborna:campaigns:trigger')
    ...
    private function triggerCampaign(Campaign $campaign)
    {
        ...
        try {
            $this->output->writeln('<info>'.$this->translator->trans('autoborna.campaign.trigger.triggering', ['%id%' => $campaign->getId()]).'</info>');
            // Reset batch limiter
    ...
    private function executeKickoff()
    {
        ...
        $this->output->writeln('<comment>'.$this->translator->trans('autoborna.campaign.trigger.starting').'</comment>');
    ...
    {
        $this->output->writeln('<comment>'.$this->translator->trans('autoborna.campaign.trigger.scheduled').'</comment>');
    ...
    private function executeInactive()
    {
        ...
        $this->output->writeln('<comment>'.$this->translator->trans('autoborna.campaign.trigger.negative').'</comment>');
