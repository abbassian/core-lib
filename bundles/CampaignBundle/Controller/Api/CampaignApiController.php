...
class CampaignApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->membershipManager = $this->get('autoborna.campaign.membership.manager');
    ...
    protected function preSaveEntity(&$entity, $form, $parameters, $action = 'edit')
    {
        ...
        if ('POST' === $method || 'PUT' === $method) {
            if (empty($parameters['events'])) {
                $msg = $this->get('translator')->trans('autoborna.campaign.form.events.notempty', [], 'validators');

                return $this->returnError($msg, Response::HTTP_BAD_REQUEST);
            } elseif (empty($parameters['lists']) && empty($parameters['forms'])) {
                $msg = $this->get('translator')->trans('autoborna.campaign.form.sources.notempty', [], 'validators');
    ...
    public function getContactsAction($id)
    {
        ...
        return $this->forward(
            'AutobornaCoreBundle:Api\StatsApi:list',
            [
    ...
    public function cloneCampaignAction($campaignId)
    {
        ...
        $route               = 'autoborna_api_campaigns_getone';
