...
use Autoborna\CoreBundle\Entity\PublishStatusIconAttributesInterface;
use Autoborna\FormBundle\Entity\Form;
use Autoborna\LeadBundle\Entity\Lead as Contact;
...
class Campaign extends FormEntity implements PublishStatusIconAttributesInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('campaigns')
            ->setCustomRepositoryClass('Autoborna\CampaignBundle\Entity\CampaignRepository');
        ...
        $builder->createManyToMany('lists', 'Autoborna\LeadBundle\Entity\LeadList')
        ...
        $builder->createManyToMany('forms', 'Autoborna\FormBundle\Entity\Form')
     ...
     *
     * @param                                     $key
     * @param \Autoborna\CampaignBundle\Entity\Event $event
     *
     * @return Campaign
     */
    ...
    {
        return 'Autoborna.confirmationCampaignPublishStatus(mQuery(this));';
    }
    ...
    {
        return [
            'data-message'      => 'autoborna.campaign.form.confirmation.message',
            'data-confirm-text' => 'autoborna.campaign.form.confirmation.confirm_text',
            'data-cancel-text'  => 'autoborna.campaign.form.confirmation.cancel_text',
        ];
    }
}
