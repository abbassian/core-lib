...
use Autoborna\CampaignBundle\Entity\Result\CountResult;
...
class CampaignRepository extends CommonRepository
{
    ...
    public function getEntities(array $args = [])
    {
        $q = $this->getEntityManager()
            ...
            ->from('AutobornaCampaignBundle:Campaign', $this->getTableAlias(), $this->getTableAlias().'.id')
    ...
    public function getPublishedCampaigns($specificId = null, $leadId = null, $forList = false, $viewOther = false)
    {
        $q = $this->getEntityManager()->createQueryBuilder()
            ->from('AutobornaCampaignBundle:Campaign', 'c', 'c.id');
    ...
    public function fetchEmailIdsById($id)
    {
        ...
        foreach ($emails as $email) {
            ...
            $return[] = $email['channelId']; // autoborna_campaign_events.channel_id
        }
