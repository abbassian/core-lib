...
class Event implements ChannelInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('campaign_events')
            ->setCustomRepositoryClass('Autoborna\CampaignBundle\Entity\EventRepository')
     ...
     * Get campaign.
     *
     * @return \Autoborna\CampaignBundle\Entity\Campaign
     */
     ...
     * Add children.
     *
     * @param \Autoborna\CampaignBundle\Entity\Event $children
     *
     * @return Event
     */
     ...
     * Set parent.
     *
     * @param \Autoborna\CampaignBundle\Entity\Event $parent
     *
     * @return Event
     */
     ...
     * Get parent.
     *
     * @return \Autoborna\CampaignBundle\Entity\Event
     */
