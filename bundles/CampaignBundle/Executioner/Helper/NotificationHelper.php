...
namespace Autoborna\CampaignBundle\Executioner\Helper;
...
class NotificationHelper
{
    ...
    public function notifyOfFailure(Lead $contact, Event $event)
    {
        ...
        $this->notificationModel->addNotification(
            ...
            $this->translator->trans(
                'autoborna.campaign.event.failed',
                [
    ...
    public function notifyOfUnpublish(Event $event): void
    {
        ...
        $this->notificationModel->addNotification(
            ...
            false,
            $this->translator->trans(
                'autoborna.campaign.event.failed.campaign.unpublished',
                [
        ...
        $subject = $this->translator->trans(
            'autoborna.campaign.event.campaign_unpublished.title',
            [
