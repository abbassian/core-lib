...
use Autoborna\CampaignBundle\Executioner\ContactFinder\KickoffContactFinder;
...
use Autoborna\CampaignBundle\Executioner\Exception\NoEventsFoundException;
        ...
        if (!($this->output instanceof NullOutput)) {
            ...
            $this->output->writeln(
                $this->translator->trans(
                    'autoborna.campaign.trigger.event_count',
                    [
