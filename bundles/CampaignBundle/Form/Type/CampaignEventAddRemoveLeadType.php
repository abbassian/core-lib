...
class CampaignEventAddRemoveLeadType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('addTo', CampaignListType::class, [
            'label'      => 'autoborna.campaign.form.addtocampaigns',
            ...
            'this_translation' => 'autoborna.campaign.form.thiscampaign_restart',
        ]);

        $builder->add('removeFrom', CampaignListType::class, [
            'label'      => 'autoborna.campaign.form.removefromcampaigns',
            'label_attr' => ['class' => 'control-label'],
            'attr'       => [
                'class' => 'form-control',
            ],
