...
use Autoborna\CampaignBundle\Form\Type\CampaignType;
...
class CampaignModel extends CommonFormModel
{
    ...
    {
        $repo = $this->em->getRepository('AutobornaCampaignBundle:Campaign');
    ...
    {
        return $this->em->getRepository('AutobornaCampaignBundle:Event');
    }

    /**
     * @return \Autoborna\CampaignBundle\Entity\LeadRepository
     */
    public function getCampaignLeadRepository()
    {
        return $this->em->getRepository('AutobornaCampaignBundle:Lead');
    }

    /**
     * @return \Autoborna\CampaignBundle\Entity\LeadEventLogRepository
     */
    public function getCampaignLeadEventLogRepository()
    {
        return $this->em->getRepository('AutobornaCampaignBundle:LeadEventLog');
    }
    ...
    {
        if ($entity instanceof \Autoborna\CampaignBundle\Entity\Lead) {
            return;
        }
    ...
    public function setLeadSources(Campaign $entity, $addedSources, $deletedSources)
    {
        foreach ($addedSources as $type => $sources) {
            foreach ($sources as $id => $label) {
                switch ($type) {
                    case 'lists':
                        $entity->addList($this->em->getReference('AutobornaLeadBundle:LeadList', $id));
                        break;
                    case 'forms':
                        $entity->addForm($this->em->getReference('AutobornaFormBundle:Form', $id));
                        break;
                    default:
                        break;
                }
        ...
        foreach ($deletedSources as $type => $sources) {
            foreach ($sources as $id => $label) {
                switch ($type) {
                    case 'lists':
                        $entity->removeList($this->em->getReference('AutobornaLeadBundle:LeadList', $id));
                        break;
                    case 'forms':
                        $entity->removeForm($this->em->getReference('AutobornaFormBundle:Form', $id));
                        break;
                    default:
                        break;
                }
    ...
    public function getLeadDetails($campaign, $leads = null)
    {
        ...
        return $this->em->getRepository('AutobornaCampaignBundle:Lead')->getLeadDetails($campaignId, $leads);
    }
    ...
    public function getCampaignLeads($campaign, $event = null)
    {
        ...
        return $this->em->getRepository('AutobornaCampaignBundle:Lead')->getLeads($campaignId, $eventId);
    }
    ...
    public function getLeadsAddedLineChartData($unit, \DateTime $dateFrom, \DateTime $dateTo, $dateFormat = null, $filter = [], $canViewOthers = true)
    {
        ...
        $chart->setDataset($this->translator->trans('autoborna.campaign.campaign.leads'), $data);
    ...
    public function getCampaignMetricsLineChartData($unit, \DateTime $dateFrom, \DateTime $dateTo, $dateFormat = null, $filter = [])
    {
        ...
        $chart->setDataset($this->translator->trans('autoborna.campaign.campaign.leads'), $contacts);
            ...
            if ($events) {
                foreach ($events as $type => $eventIds) {
                    ...
                    if (!empty($rawData)) {
                        ...
                        $chart->setDataset($this->translator->trans('autoborna.campaign.'.$type), $triggers);
                    }
                }
