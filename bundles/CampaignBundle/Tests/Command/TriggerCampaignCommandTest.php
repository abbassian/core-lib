...
namespace Autoborna\CampaignBundle\Tests\Command;
...
class TriggerCampaignCommandTest extends AbstractCampaignCommand
{
    ...
    protected function setUp(): void
    {
        ...
        $this->segmentCountCacheHelper = self::$container->get('autoborna.helper.segment.count.cache');
    }
    ...
    public function testCampaignExecutionForAll()
    {
        ...
        $this->runCommand('autoborna:campaigns:trigger', ['-i' => 1, '-l' => 10]);
    ...
    {
        $this->runCommand('autoborna:campaigns:trigger', ['-i' => 1, '--contact-id' => 1]);
    ...
    {
        $this->runCommand('autoborna:campaigns:trigger', ['-i' => 1, '--contact-ids' => '1,2,3,4,19']);
    ...
    public function testCampaignActionChangeMembership(): void
    {
        ...
        $this->runCommand('autoborna:campaigns:trigger', ['--campaign-id' => $campaign1->getId(), '--contact-id' => $lead->getId(), '--kickoff-only' => true]);
    ...
    public function testSegmentCacheCount(): void
    {
        ...
        $this->runCommand('autoborna:campaigns:trigger', ['-i' => 1]);
