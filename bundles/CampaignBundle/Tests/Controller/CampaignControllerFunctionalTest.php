...
use Autoborna\CampaignBundle\Command\SummarizeCommand;
...
class CampaignControllerFunctionalTest extends AbstractCampaignTest
{
    ...
    protected function setUp(): void
    {
        ...
        parent::setUp();
        $this->campaignModel      = self::$container->get('autoborna.model.factory')->getModel('campaign');
        $this->campaignLeadsLabel = self::$container->get('translator')->trans('autoborna.campaign.campaign.leads');
    }
