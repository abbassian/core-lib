...
use DOMElement;
use Autoborna\CampaignBundle\Tests\Campaign\AbstractCampaignTest;
...
final class CampaignUnpublishedWorkflowFunctionalTest extends AbstractCampaignTest
{
    ...
    public function testCampaignEditPageCheckUnpublishWorkflowAttributesPresent(): void
    {
        ...
        $attributes = [
            ...
            'data-message'          => $translator->trans('autoborna.campaign.form.confirmation.message'),
            'data-confirm-text'     => $translator->trans('autoborna.campaign.form.confirmation.confirm_text'),
            'data-confirm-callback' => 'dismissConfirmation',
            'data-cancel-text'      => $translator->trans('autoborna.campaign.form.confirmation.cancel_text'),
    ...
    public function testCampaignListPageCheckUnpublishWorkflowAttributesPresent(): void
    {
        ...
        $attributes    = [
            'onclick'               => 'Autoborna.confirmationCampaignPublishStatus(mQuery(this));',
            'data-toggle'           => 'confirmation',
