...
<div class="hide" id="CampaignEventPanel">
        ...
        <div class="row">
                ...
                <div class="panel panel-success mb-0">
                    <div class="panel-heading">
                        <div class="col-xs-8 col-sm-10 np">
                            <h3 class="panel-title"><?php echo $view['translator']->trans('autoborna.campaign.event.decision.header'); ?></h3>
                        </div>
                        <div class="col-xs-4 col-sm-2 pl-0 pr-0 pt-10 pb-10 text-right">
                            ...
                            <button class="visible-xs pull-right btn btn-sm btn-default btn-nospin text-success" data-type="Decision">
                                <?php echo $view['translator']->trans('autoborna.core.select'); ?>
                            </button>
                        </div>
                    </div>
                    <div class="panel-body">
                        <?php echo $view['translator']->trans('autoborna.campaign.event.decision.descr'); ?>
                    </div>
            ...
            <div class="mr-0 ml-0 pl-xs pr-xs campaign-group-container col-md-4 " id="ActionGroupSelector">
                <div class="panel panel-primary mb-0">
                    <div class="panel-heading">
                        <div class="col-xs-8 col-sm-10 np">
                            <h3 class="panel-title"><?php echo $view['translator']->trans('autoborna.campaign.event.action.header'); ?></h3>
                        </div>
                        <div class="col-xs-4 col-sm-2 pl-0 pr-0 pt-10 pb-10 text-right">
                    ...
                    <div class="panel-body">
                        <?php echo $view['translator']->trans('autoborna.campaign.event.action.descr'); ?>
                    </div>
                    <div class="hidden-xs panel-footer text-center">
            ...
            <div class="mr-0 ml-0 pl-xs pr-xs campaign-group-container col-md-4" id="ConditionGroupSelector">
                <div class="panel panel-danger mb-0">
                    <div class="panel-heading">
                        <div class="col-xs-8 col-sm-10 np">
                            <h3 class="panel-title"><?php echo $view['translator']->trans('autoborna.campaign.event.condition.header'); ?></h3>
                        </div>
                        <div class="col-xs-4 col-sm-2 pl-0 pr-0 pt-10 pb-10 text-right">
                    ...
                    <div class="panel-body"><?php echo $view['translator']->trans('autoborna.campaign.event.condition.descr'); ?></div>
                    <div class="hidden-xs panel-footer text-center">
    ...
    <div id="CampaignEventPanelLists" class="hide">
        <?php
        echo $view->render('AutobornaCampaignBundle:Campaign\Builder:source_list.html.php',
            [
        ...
        echo $view->render('AutobornaCampaignBundle:Campaign\Builder:event_list.html.php',
            [
