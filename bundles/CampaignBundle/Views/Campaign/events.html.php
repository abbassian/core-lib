...
<ul class="list-group campaign-event-list">
    <?php foreach ($events as $event) : ?>
        ...
        <?php $percentLabel = ('danger' === $typeClass) ? 'autoborna.report.campaign.no.percent' : 'autoborna.report.campaign.yes.percent'; ?>
        ...
        <li class="list-group-item bg-auto bg-light-xs">
            ...
            <div class="box-layout">
                <div class="visible-sm visible-md visible-lg col-stats">
                    ...
                    <span class="label label-danger" data-toggle="tooltip" title="<?php echo $view['translator']->trans('autoborna.report.campaign.no.percent'); ?>">
                        <?php echo $event['noPercent'].'%'; ?>
                    </span>
                    <?php endif; ?>
                <span class="mt-xs label label-warning" data-toggle="tooltip" title="<?php echo $view['translator']->trans('autoborna.report.campaign.completed.actions'); ?>">
                    <?php echo $event['logCountProcessed']; ?>
                </span>
                <span class="mt-xs label label-default"  data-toggle="tooltip" title="<?php echo $view['translator']->trans('autoborna.report.campaign.pending.actions'); ?>">
                ...
                <div class="col-md-3 va-m text-right">
                    <em class="text-white dark-sm"><?php echo $view['translator']->trans('autoborna.campaign.'.$event['type']); ?></em>
                </div>
            </div>
        </li>
    <?php endforeach; ?>
