                        ...
                        <div class="col-xs-4 va-m">
                            <div class="panel-body">
                                <span class="img-wrapper img-rounded" style="width:100%">
                                    ...
                                    <?php else : ?>
                                        <?php $socialData = \Autoborna\CoreBundle\Helper\Serializer::decode($item['social_cache']); ?>
                        ...
                        <div class="col-xs-8 va-t">
                            <div class="panel-body">
                                ...
                                <h4 class="fw-sb mb-xs">
                                    <a href="<?php echo $view['router']->path('autoborna_contact_action', ['objectAction' => 'view', 'objectId' => $item['id']]); ?>" data-toggle="ajax">
                                        <span>
                                            <?php
                                            ...
                                            elseif (!empty($item['email'])):
                                                ...
                                                echo $view['translator']->trans('autoborna.lead.lead.anonymous');
                                            endif;
                                            ?>
                                        </span>
                                    </a>
...
<div class="panel-footer">
    <?php
    $link = (isset($link)) ? $link : 'autoborna_contact_index';
    echo $view->render('AutobornaCoreBundle:Helper:pagination.html.php', [
