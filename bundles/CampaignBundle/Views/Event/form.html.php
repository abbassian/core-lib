    ...
    <div<?php echo $hideTriggerMode ? ' class="hide"' : ''; ?>>
        ...
        <div<?php echo ('interval' != $form['triggerMode']->vars['data']) ? ' class="hide"' : ''; ?> id="triggerInterval">
            ...
            <div id="interval_settings" class="hide">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div style="display:inline-block; font-weight: 600;"><?php echo $view['translator']->trans('autoborna.campaign.form.type.interval_schedule_at'); ?> </div>
                        <div style="width: 75px; display:inline-block; margin:0 10px 0 10px;"><?php echo $view['form']->widget($form['triggerHour']); ?></div>
                        <div style="display:inline-block; font-weight: 600;"> <?php echo $view['translator']->trans('autoborna.campaign.form.type.interval_schedule_between_hours'); ?> </div>
                        ...
                        <div style="display:inline-block; font-weight: 600;"> <?php echo $view['translator']->trans('autoborna.core.and'); ?> </div>
                ...
                <hr />
                <div class="row mt-5">
                    <div class="col-sm-12" style="font-weight: 600;"><?php echo $view['translator']->trans('autoborna.campaign.form.type.interval_trigger_restricted_dow'); ?></div>
                </div>
                <div class="row">
                    <div class="col-sm-3">
                        <div class="checkbox">
