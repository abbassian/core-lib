            ...
            $event->addButton(
                [
                    'attr' => [
                        ...
                        'href'        => $this->router->generate('autoborna_category_batch_contact_view'),
                        'data-header' => $this->translator->trans('autoborna.lead.batch.categories'),
                    ],
                    'btnText'   => $this->translator->trans('autoborna.lead.batch.categories'),
