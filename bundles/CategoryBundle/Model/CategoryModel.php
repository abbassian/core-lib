...
namespace Autoborna\CategoryBundle\Model;

use Autoborna\CategoryBundle\CategoryEvents;
use Autoborna\CategoryBundle\Entity\Category;
use Autoborna\CategoryBundle\Event\CategoryEvent;
use Autoborna\CategoryBundle\Form\Type\CategoryType;
...
class CategoryModel extends FormModel
{
    ...
    {
        return $this->em->getRepository('AutobornaCategoryBundle:Category');
    }
