...
class SendChannelBroadcastCommand extends ModeratedCommand
{
    ...
    {
        $this->setName('autoborna:broadcasts:send')
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $translator->setLocale($this->getContainer()->get('autoborna.helper.core_parameters')->get('locale'));
        ...
        $table
            ->setHeaders([$translator->trans('autoborna.core.channel'), $translator->trans('autoborna.core.channel.broadcast_success_count'), $translator->trans('autoborna.core.channel.broadcast_failed_count')])
            ->setRows($rows);
        $table->render();
