...
class MessageSendType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            [
                'label'       => 'autoborna.channel.send.selectmessages',
                'label_attr'  => ['class' => 'control-label'],
                'multiple'    => false,
                'required'    => true,
                'constraints' => [
                    new NotBlank(
                        ['message' => 'autoborna.channel.choosemessage.notblank']
                    ),
                ],
            ]
        );
        ...
        if (!empty($options['update_select'])) {
            ...
            $builder->add(
                ...
                [
                    ...
                    'label' => 'autoborna.channel.create.new.message',
                ]
            );
            ...
            $builder->add(
                ...
                [
                    'attr' => [
                        'class'    => 'btn btn-primary btn-nospin',
                        'onclick'  => 'Autoborna.loadNewWindow({windowUrl: \''.$windowUrlEdit.'\'})',
                        'disabled' => !isset($options['data']['message']),
                        'icon'     => 'fa fa-edit',
                    ],
                    'label' => 'autoborna.channel.send.edit.message',
                ]
            );
        }
    }
