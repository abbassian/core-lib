...
namespace Autoborna\ChannelBundle\Model;
...
use Autoborna\ChannelBundle\Event\MessageQueueEvent;
use Autoborna\ChannelBundle\Event\MessageQueueProcessEvent;
...
class MessageQueueModel extends FormModel
{
    ...
    /**
     * @return \Doctrine\ORM\EntityRepository|\Autoborna\ChannelBundle\Entity\MessageQueueRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('AutobornaChannelBundle:MessageQueue');
    }
    ...
    public function processFrequencyRules(
        ...
        /** @var \Autoborna\LeadBundle\Entity\FrequencyRuleRepository $frequencyRulesRepo */
        $frequencyRulesRepo     = $this->em->getRepository('AutobornaLeadBundle:FrequencyRule');
    ...
    public function queue(
        ...
        foreach ($leads as $lead) {
            ...
            if ($campaignEventId) {
                $messageQueue->setEvent($this->em->getReference('AutobornaCampaignBundle:Event', $campaignEventId));
            }
            ...
            $messageQueue->setLead(
                ($lead instanceof Lead) ? $lead : $this->em->getReference('AutobornaLeadBundle:Lead', $leadId)
            );
    ...
    public function sendMessages($channel = null, $channelId = null)
    {
        ...
        while ($queue = $this->getRepository()->getQueuedMessages($limit, $processStarted, $channel, $channelId)) {
            ...
            $this->em->clear(\Autoborna\CampaignBundle\Entity\Event::class);
        }
