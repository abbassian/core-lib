...
namespace Autoborna\ChannelBundle\Tests\EventListener;
...
use Autoborna\ChannelBundle\EventListener\CampaignSubscriber;
use Autoborna\ChannelBundle\Form\Type\MessageSendType;
...
class CampaignSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $factory = $this->getMockBuilder(AutobornaFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
                        ...
                        case 'sms.send_text_sms':
                            return new ActionAccessor(
                                [
                                    ...
                                    'timelineTemplate' => 'AutobornaSmsBundle:SubscribedEvents\Timeline:index.html.php',
                                    'channel'          => 'sms',
                                    'channelIdField'   => 'sms',
                                ]
                            );
    ...
    public function testCorrectChannelIsUsed()
    {
        ...
        $config = new ActionAccessor(
            [
                'label'                  => 'autoborna.channel.message.send.marketing.message',
                'description'            => 'autoborna.channel.message.send.marketing.message.descr',
                'batchEventName'         => ChannelEvents::ON_CAMPAIGN_BATCH_ACTION,
                'formType'               => MessageSendType::class,
                'formTheme'              => 'AutobornaChannelBundle:FormTheme\MessageSend',
                ...
                'timelineTemplate'       => 'AutobornaChannelBundle:SubscribedEvents\Timeline:index.html.php',
