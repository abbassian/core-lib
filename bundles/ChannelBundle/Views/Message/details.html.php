...
$view['slots']->set('autobornaContent', 'message');
        ...
        <!--/ form detail collapseable toggler -->
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                    ...
                                    <div class="col-md-6 va-m">
                                        <h5 class="text-white dark-md fw-sb mb-xs">
                                            <div><i class="fa fa-line-chart pull-left"></i>
                                                <span class="pull-left"> <?php echo $view['translator']->trans('autoborna.messages.processed.messages'); ?></span></div>
                                        </h5>
                                    </div>
                                ...
                                <div class="pt-0 pl-15 pb-10 pr-15">
                                    <?php echo $view->render('AutobornaCoreBundle:Helper:chart.html.php', ['chartData' => $eventCounts, 'chartType' => 'line', 'chartHeight' => 300]); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <ul class="nav nav-tabs pr-md pl-md">
                    ...
                    <li class="<?php echo $active; ?>">
                        <a href="#contacts-<?php echo $channel; ?>" role="tab" data-toggle="tab">
                            <?php echo ('all' !== $channel) ? $channels[$channel]['label'] : $view['translator']->trans('autoborna.lead.leads'); ?>
                        </a>
                    </li>
                    <?php $active = ''; ?>
                    <?php endforeach; ?>
            ...
            <div class="tab-content pa-md">
                ...
                <div class="tab-pane bdr-w-0 page-list<?php echo $active; ?>" id="contacts-<?php echo $channel; ?>">
                    <?php $message = ('all' === $channel) ? 'autoborna.channel.message.all_contacts' : 'autoborna.channel.message.channel_contacts'; ?>
