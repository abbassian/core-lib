...
namespace Autoborna\ConfigBundle\Form\Helper;

use Autoborna\ConfigBundle\Mapper\Helper\RestrictionHelper as FieldHelper;
                    ...
                    array_merge(
                        ...
                        [
                            ...
                            'attr'     => array_merge($childType->getConfig()->getOptions()['attr'] ?? [], [
                                'placeholder' => $this->translator->trans('autoborna.config.restricted'),
                                'readonly'    => true,
                            ]),
                        ]
                    )
