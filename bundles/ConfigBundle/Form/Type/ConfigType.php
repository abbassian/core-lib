...
namespace Autoborna\ConfigBundle\Form\Type;
...
class ConfigType extends AbstractType
{
    ...
    {
        // TODO very dirty quick fix for https://github.com/autoborna/autoborna/issues/8854
        ...
        $builder->add(
            ...
            [
                'apply_onclick' => 'Autoborna.activateBackdrop()',
                'save_onclick'  => 'Autoborna.activateBackdrop()',
            ]
        );
