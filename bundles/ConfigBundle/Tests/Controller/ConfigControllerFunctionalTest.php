...
class ConfigControllerFunctionalTest extends AutobornaMysqlTestCase
{
    /**
     * @var string
     */
    ...
    public function testValuesAreEscapedProperly(): void
    {
        ...
        $trackIps        = "%ip1%\n%ip2%\n%kernel.root_dir%\n%kernel.project_dir%";
        $googleAnalytics = 'reveal pass: %autoborna.db_password%';
        ...
        $form->setValues(
            [
                'config[coreconfig][site_url]'           => 'https://autoborna-community.local', // required
    ...
    public function testUserAndSystemLocale(): void
    {
        ...
        $configForm->setValues(
            [
                ...
                'config[coreconfig][site_url]' => 'https://autoborna-cloud.local', // required
            ]
        );
