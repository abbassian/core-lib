...
namespace Autoborna\ConfigBundle\Tests\Form\Helper;

use Autoborna\ConfigBundle\Form\Helper\RestrictionHelper;
use Autoborna\ConfigBundle\Form\Type\ConfigType;
use Autoborna\ConfigBundle\Form\Type\EscapeTransformer;
...
use Autoborna\EmailBundle\EventListener\ProcessBounceSubscriber;
use Autoborna\EmailBundle\EventListener\ProcessUnsubscribeSubscriber;
use Autoborna\EmailBundle\Form\Type\ConfigMonitoredEmailType;
use Autoborna\EmailBundle\Form\Type\ConfigMonitoredMailboxesType;
use Autoborna\EmailBundle\Form\Type\ConfigType as EmailConfigType;
...
class RestrictionHelperTest extends TypeTestCase
{
    ...
    private $forms = [
        'emailconfig' => [
            ...
            'formTheme'  => 'AutobornaEmailBundle:FormTheme\\Config',
            'parameters' => [
                'mailer_api_key'               => null,
     ...
     *
     * @covers \Autoborna\ConfigBundle\Form\Helper\RestrictionHelper::applyRestrictions()
     * @covers \Autoborna\ConfigBundle\Form\Helper\RestrictionHelper::restrictField()
     */
    ...
    public function testRestrictedFieldsAreMasked()
    {
        ...
        $this->assertEquals(
            [
                ...
                'placeholder'  => 'autoborna.config.restricted',
                'readonly'     => true,
            ],
        ...
        return [
            ...
            new PreloadedExtension(
                [
                    ...
                    new FormButtonsType(),
                    new ButtonGroupType(),
                    new \Autoborna\EmailBundle\Form\Type\ConfigType($translator, $transportType),
