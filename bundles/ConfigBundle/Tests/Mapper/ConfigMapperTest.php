...
namespace Autoborna\ConfigBundle\Tests\Mapper;

use Autoborna\ConfigBundle\Exception\BadFormConfigException;
use Autoborna\ConfigBundle\Mapper\ConfigMapper;
...
class ConfigMapperTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers  \Autoborna\ConfigBundle\Exception\BadFormConfigException
     * @covers  \Autoborna\ConfigBundle\Mapper\ConfigMapper::bindFormConfigsWithRealValues()
     */
     ...
     *
     * @covers  \Autoborna\ConfigBundle\Mapper\ConfigMapper::bindFormConfigsWithRealValues()
     * @covers  \Autoborna\ConfigBundle\Mapper\ConfigMapper::mergeWithLocalParameters()
     */
