 ...
 * @param el
 */
Autoborna.activateSortablePanels = function (container) {
...
console.log(prototype);
            if (mQuery(prototype).length) {
                console.log('exists');
                Autoborna.appendSortablePanel(sortablesContainer, prototype);
            }
    ...
    mQuery(sortable).find('.sortable-panel-wrapper').each(function() {
        Autoborna.activateSortablePanel(mQuery(this).closest('.panel'));
    });
};
 ...
 * @param modal
 */
Autoborna.appendSortablePanel = function(sortablesContainer, modal) {
    ...
    Autoborna.renameFormElements(newModal, oldIdPrefix, oldNamePrefix, newIdPrefix, newNamePrefix)

    Autoborna.activateModalEmbeddedForms('#'+mQuery(newModal).attr('id'));

    Autoborna.showModal(newModal);
 ...
 * @param modal
 */
Autoborna.updateSortablePanel = function(modalBtn, modal) {
    ...
    Autoborna.activateSortablePanel(panel);
    ...
    Autoborna.toggleSortablePanelAddMessage(mQuery(panel).closest('.sortable-panels'));
};
 ...
 * @param panel
 */
Autoborna.deleteSortablePanel = function(panel) {
    var panelContainer = mQuery(panel).closest('.sortable-panels');
    mQuery(panel).remove();

    Autoborna.toggleSortablePanelAddMessage(panelContainer);
};
 ...
 * @param modal
 */
Autoborna.cancelSortablePanel = function(modalBtn, modal) {
    setTimeout(function () {
 ...
 */
Autoborna.toggleSortablePanelAddMessage = function(panelContainer) {
