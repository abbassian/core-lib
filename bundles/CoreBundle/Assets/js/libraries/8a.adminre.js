        ...
        PLUGINS: function () {
            ...
            (function () {
                ...
                function toggleMinimize (e) {
                    var backgroundImage = /^url\(.+$/.test($('.autoborna-brand').css('background-image'));
                    ...
                    if($(element).hasClass("sidebar-minimized")) {
                        ...
                        if (backgroundImage) {
                            $('.autoborna-brand, .sidebar-header').removeClass('minimized');
                        }
                        ...
                        if (backgroundImage) {
                            $('.autoborna-brand, .sidebar-header').addClass('minimized');
                        }
