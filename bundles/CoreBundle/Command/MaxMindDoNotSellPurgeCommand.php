...
use Autoborna\CoreBundle\IpLookup\DoNotSellList\MaxMindDoNotSellList;
...
/**
 * CLI Command to purge data from Autoborna that appears on the
...
class MaxMindDoNotSellPurgeCommand extends Command
{
    ...
    {
        $this->setName('autoborna:max-mind:purge')
            ...
            ->setHelp(<<<'EOT'
The <info>%command.name%</info> command will purge all data from Autoborna which is related to any IP found on the MaxMind Do Not Sell List.
