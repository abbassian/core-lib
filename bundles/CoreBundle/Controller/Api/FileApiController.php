...
class FileApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->allowedExtensions = $this->get('autoborna.helper.core_parameters')->get('allowed_extensions');
    ...
    protected function getAbsolutePath($dir, $createDir = false)
    {
        try {
            ...
            if ('images' === $dir) {
                $absoluteDir = realpath($this->get('autoborna.helper.paths')->getSystemPath($dir, true));
            } elseif ('assets' === $dir) {
                $absoluteDir = realpath($this->get('autoborna.helper.core_parameters')->get('upload_dir'));
            }
            ...
            $this->get('monolog.logger.autoborna')->error($e->getMessage(), ['exception' => $e]);
    ...
    protected function getMediaUrl()
    {
        return $this->request->getScheme().'://'
            ...
            .$this->get('autoborna.helper.core_parameters')->get('image_path');
    }
}
