...
namespace Autoborna\CoreBundle\Doctrine;
...
abstract class AbstractAutobornaMigration extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function setContainer(ContainerInterface $container = null)
    {
        ...
        $this->prefix        = $container->getParameter('autoborna.db_table_prefix');
