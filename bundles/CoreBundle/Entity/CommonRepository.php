...
class CommonRepository extends EntityRepository
{
    ...
    {
        return ['autoborna.core.searchcommand.ids'];
    }
    ...
    public function getStandardSearchCommands()
    {
        return [
            ...
            'autoborna.core.searchcommand.ids',
        ];
    }
    ...
    protected function addSearchCommandWhereClause($q, $filter)
    {
        ...
        switch ($command) {
            case $this->translator->trans('autoborna.core.searchcommand.ids'):
            case $this->translator->trans('autoborna.core.searchcommand.ids', [], null, 'en_US'):
    ...
    protected function addStandardSearchCommandWhereClause(&$q, $filter)
    {
        ...
        switch ($command) {
            ...
            case $this->translator->trans('autoborna.core.searchcommand.isunpublished', [], null, 'en_US'):
                ...
                break;
            case $this->translator->trans('autoborna.core.searchcommand.isuncategorized'):
            case $this->translator->trans('autoborna.core.searchcommand.isuncategorized', [], null, 'en_US'):
                $expr = $q->expr()->orX(
            ...
            case $this->translator->trans('autoborna.core.searchcommand.ismine', [], null, 'en_US'):
                ...
                break;
            case $this->translator->trans('autoborna.core.searchcommand.category'):
            case $this->translator->trans('autoborna.core.searchcommand.category', [], null, 'en_US'):
     ...
     *
     * @see \Autoborna\LeadBundle\Segment\RandomParameterName
