...
namespace Autoborna\CoreBundle\ErrorHandler {
    use Autoborna\CoreBundle\Exception\DatabaseConnectionException;
    use Autoborna\CoreBundle\Exception\ErrorHandlerException;
    ...
    class ErrorHandler
    {
        ...
        /**
         * Log fatal error to Autoborna's logs and throw exception for the parent generic error page to catch.
         *
         * @throws \Exception
         */
