...
namespace Autoborna\CoreBundle\Form\Extension;

use Autoborna\CoreBundle\CoreEvents;
use Autoborna\CoreBundle\Event\CustomFormEvent;
...
trigger_deprecation('autoborna/core', '4.3', 'The "%s" class is deprecated, will be removed in 5.0.', CustomFormExtension::class);
