...
class DateRangeType extends AbstractType
{
    ...
    {
        $humanFormat     = 'M j, Y';
        $sessionDateFrom = $this->session->get('autoborna.daterange.form.from');
        $sessionDateTo   = $this->session->get('autoborna.daterange.form.to');
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.core.date.from',
        ...
        $builder->add(
            ...
            SubmitType::class,
            [
                'label' => 'autoborna.core.form.apply',
        ...
        $this->session->set('autoborna.daterange.form.from', $dateFrom->format($humanFormat));
        $this->session->set('autoborna.daterange.form.to', $dateTo->format($humanFormat));
    }
