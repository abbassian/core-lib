...
use Autoborna\CoreBundle\Helper\ListParser\ArrayListParser;
use Autoborna\CoreBundle\Helper\ListParser\BarListParser;
use Autoborna\CoreBundle\Helper\ListParser\Exception\FormatNotSupportedException;
use Autoborna\CoreBundle\Helper\ListParser\JsonListParser;
use Autoborna\CoreBundle\Helper\ListParser\ListParserInterface;
use Autoborna\CoreBundle\Helper\ListParser\ValueListParser;
...
abstract class AbstractFormFieldHelper
{
    ...
    public function getChoiceList($customFields = [])
    {
        ...
        foreach ($this->getTypes() as $v => $type) {
            $choices[$this->translator->transConditional("autoborna.core.type.{$v}", "{$this->translationKeyPrefix}{$v}")] = $v;
        }
