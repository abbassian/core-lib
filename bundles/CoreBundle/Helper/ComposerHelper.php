...
class ComposerHelper
{
     ...
     *
     * @param string $packageName The package name, e.g. autoborna/example-plugin
    ...
    {
        /**
         * "composer remove package-name" also triggers an update of all other Autoborna dependencies.
     ...
     *
     * @param string $packageName The package name, e.g. autoborna/exmple-plugin
     */
    ...
    /**
     * Returns a list of installed Composer packages that are of type autoborna-plugin.
     *
     * @return string[]
     */
    public function getAutobornaPluginPackages(): array
    {
        return \Composer\InstalledVersions::getInstalledPackagesByType('autoborna-plugin');
    }
