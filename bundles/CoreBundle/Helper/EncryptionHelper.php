...
use Autoborna\CoreBundle\Security\Cryptography\Cipher\Symmetric\SymmetricCipherInterface;
use Autoborna\CoreBundle\Security\Exception\Cryptography\Symmetric\InvalidDecryptionException;
...
class EncryptionHelper
{
    ...
    public function __construct(
        ...
        $this->key = $coreParametersHelper->get('autoborna.secret_key');
    }
