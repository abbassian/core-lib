...
abstract class AbstractCommonModel
{
     ...
     *
     * @return \Autoborna\CoreBundle\Entity\CommonRepository|bool
     */
    public function getRepository()
    {
        ...
        if (null === $commonRepo) {
            $commonRepo = new CommonRepository($this->em, new ClassMetadata('AutobornaCoreBundle:FormEntity'));
        }
    ...
    public function getEntityBySlugs($slug)
    {
        ...
        if ($this->translator->trans('autoborna.core.url.uncategorized') == $category) {
            $category = null;
        }
