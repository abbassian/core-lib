...
namespace Autoborna\CoreBundle\Release;
...
class Metadata implements \JsonSerializable
{
     ...
     * Autoborna versions anymore.
     */
    private string $showPHPVersionWarningIfUnder;

    private string $minSupportedAutobornaVersion;
    ...
    public function __construct(array $metadata)
    {
        ...
        $this->minSupportedAutobornaVersion    = $metadata['minimum_autoborna_version'];
    ...
    public function getMinSupportedAutobornaVersion(): string
    {
        return $this->minSupportedAutobornaVersion;
    }
    ...
    public function jsonSerialize()
    {
        return [
            ...
            'minimum_autoborna_version'            => $this->minSupportedAutobornaVersion,
