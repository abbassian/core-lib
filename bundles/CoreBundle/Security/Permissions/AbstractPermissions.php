...
namespace Autoborna\CoreBundle\Security\Permissions;
...
abstract class AbstractPermissions
{
    ...
    protected function addStandardFormFields($bundle, $level, &$builder, $data, $includePublish = true)
    {
        $choices = [
            ...
            'autoborna.core.permissions.edit'   => 'edit',
            'autoborna.core.permissions.create' => 'create',
            'autoborna.core.permissions.delete' => 'delete',
        ];

        if ($includePublish) {
            $choices['autoborna.core.permissions.publish'] = 'publish';
        }

        $choices['autoborna.core.permissions.full'] = 'full';

        $label = ('categories' == $level) ? 'autoborna.category.permissions.categories' : "autoborna.$bundle.permissions.$level";
        $builder->add(
            "$bundle:$level",
    ...
    {
        return ('categories' === $level) ? 'autoborna.category.permissions.categories' : "autoborna.{$bundle}.permissions.{$level}";
    }
    ...
    {
        $choices = [
            'autoborna.core.permissions.manage' => 'manage',
        ];
        ...
        $builder->add(
            ...
            [
                'choices'           => $choices,
                'label'             => "autoborna.$bundle.permissions.$level",
                'data'              => (!empty($data[$level]) ? $data[$level] : []),
                'bundle'            => $bundle,
                'level'             => $level,
            ]
    ...
    {
        $choices = [
            'autoborna.core.permissions.viewown'     => 'viewown',
            'autoborna.core.permissions.viewother'   => 'viewother',
            'autoborna.core.permissions.editown'     => 'editown',
            'autoborna.core.permissions.editother'   => 'editother',
            'autoborna.core.permissions.create'      => 'create',
            'autoborna.core.permissions.deleteown'   => 'deleteown',
            'autoborna.core.permissions.deleteother' => 'deleteother',
            'autoborna.core.permissions.full'        => 'full',
        ];

        if ($includePublish) {
            $choices['autoborna.core.permissions.publishown']   = 'publishown';
            $choices['autoborna.core.permissions.publishother'] = 'publishother';
        }
