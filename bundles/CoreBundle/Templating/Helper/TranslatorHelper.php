...
class TranslatorHelper extends BaseHelper
{
    ...
    public function getJsLang()
    {
        ...
        $oldKeys = [
            'chosenChooseOne'     => $this->trans('autoborna.core.form.chooseone'),
            'chosenChooseMore'    => $this->trans('autoborna.core.form.choosemultiple'),
            'chosenNoResults'     => $this->trans('autoborna.core.form.nomatches'),
            'pleaseWait'          => $this->trans('autoborna.core.wait'),
            'popupBlockerMessage' => $this->trans('autoborna.core.popupblocked'),
        ];
