...
namespace Autoborna\CoreBundle\Templating;
...
class TemplateNameParser extends BaseTemplateNameParser
{
    ...
    public function parse($name)
    {
        ...
        $template->setThemeHelper($this->container->get('autoborna.helper.theme'));
        $template->setPathsHelper($this->container->get('autoborna.helper.paths'));
