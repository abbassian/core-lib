...
use Autoborna\CoreBundle\Test\Session\FixedMockFileSessionStorage;
...
abstract class AbstractAutobornaTestCase extends WebTestCase
{
    use FixturesTrait {
    ...
    private function mockServices(): void
    {
        ...
        self::$container->set('autoborna.helper.cookie', $cookieHelper);
    ...
    protected function createAjaxHeaders(): array
    {
        return [
            ...
            'HTTP_X-CSRF-Token'     => $this->getCsrfToken('autoborna_ajax_post'),
        ];
    }
