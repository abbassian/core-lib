...
abstract class AutobornaMysqlTestCase extends AbstractAutobornaTestCase
{
    /**
     * @var bool
     */
    ...
    {
        $prefix     = self::$container->getParameter('autoborna.db_table_prefix');
    ...
    protected function createAnotherClient(string $username = 'admin', string $password = 'autoborna'): Client
    {
