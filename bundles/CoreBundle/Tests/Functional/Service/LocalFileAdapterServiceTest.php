...
namespace Autoborna\CoreBundle\Tests\Functional\Service;
...
class LocalFileAdapterServiceTest extends AutobornaMysqlTestCase
{
    /**
     * @var string
     */
    ...
    {
        $pathsHelper = self::$container->get('autoborna.helper.paths');
