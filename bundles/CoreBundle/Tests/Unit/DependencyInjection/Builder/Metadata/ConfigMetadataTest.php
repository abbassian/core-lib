...
class ConfigMetadataTest extends TestCase
{
    ...
    public function testConfigIsLoaded()
    {
        ...
        $this->assertTrue(isset($config['services']['helpers']['autoborna.helper.bundle']));
    ...
    public function testOptionalMissingServicesAreIgnored()
    {
        ...
        $config = $this->metadata->toArray()['config'];
        $this->assertFalse(isset($config['services']['fixtures']['autoborna.test.fixture']));
    }
    ...
    public function testParameterArgumentsAreEncoded()
    {
        ...
        $this->assertEquals('%%autoborna.bundles%%', $config['services']['helpers']['autoborna.helper.bundle']['arguments'][0]);
    }
