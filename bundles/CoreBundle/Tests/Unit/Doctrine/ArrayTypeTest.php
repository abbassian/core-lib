...
namespace Autoborna\CoreBundle\Tests\Unit\Doctrine;

use Doctrine\DBAL\Platforms\AbstractPlatform;
use Doctrine\DBAL\Platforms\MySqlPlatform;
use Doctrine\DBAL\Types\Type;
use Autoborna\CoreBundle\Doctrine\Type\ArrayType;
...
{
    const MAUTIC_ARRAY_TYPE_NAME = 'autoborna-array-type';
    ...
    protected function setUp(): void
    {
        ...
        if (!Type::hasType(self::MAUTIC_ARRAY_TYPE_NAME)) {
            Type::addType(self::MAUTIC_ARRAY_TYPE_NAME, 'Autoborna\CoreBundle\Doctrine\Type\ArrayType');
        }
    ...
    public function testGivenObjectWithPublicPropertyWhenConvertsToDatabaseValueThenGetEncodedData()
    {
        ...
        $this->assertEquals(
            'a:1:{i:0;O:68:"Autoborna\CoreBundle\Tests\Unit\Doctrine\ExampleClassWithPublicProperty":1:{s:4:"test";s:5:"value";}}',
            $result
        );
    }
