...
namespace Autoborna\CoreBundle\Tests\Unit\EventListener;
...
use Autoborna\CoreBundle\EventListener\MigrationCommandSubscriber;
...
class MigrationCommandSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddGeneratedColumnsWillRunOnlyForMigrationCommand(): void
    {
        $this->command->expects($this->once())
            ->method('getName')
            ->willReturn('autoborna:segments:update');
