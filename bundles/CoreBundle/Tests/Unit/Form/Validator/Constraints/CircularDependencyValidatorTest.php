...
namespace Autoborna\CoreBundle\Tests\Unit\Form\Validator\Constraints;

use Autoborna\CoreBundle\Form\Validator\Constraints\CircularDependency;
use Autoborna\CoreBundle\Form\Validator\Constraints\CircularDependencyValidator;
...
class CircularDependencyValidatorTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @return Autoborna\CoreBundle\Form\Validator\Constraints\CircularDependencyValidator
     */
    ...
    public function testValidateOnInvalid($message, $currentSegmentId, $filters)
    {
        $this->configureValidator($message, $currentSegmentId)
            ->validate($filters, new CircularDependency(['message' => 'autoborna.core.segment.circular_dependency_exists']));
    }

    public function validateDataProvider()
    {
        $constraint = new CircularDependency(['message' => 'autoborna.core.segment.circular_dependency_exists']);
