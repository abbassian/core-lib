...
use Autoborna\CoreBundle\Helper\ExportHelper;
...
class ExportHelperTest extends \PHPUnit\Framework\TestCase
{
    ...
    private $dummyData = [
        [
            ...
            'firstname' => 'Mautibot',
            'lastname'  => 'Autoborna',
            'email'     => 'mautibot@autoborna.org',
        ],
        [
            'id'        => 2,
            'firstname' => 'Demo',
            'lastname'  => 'Autoborna',
            'email'     => 'demo@autoborna.org',
        ],
    ];
    ...
    public function testCsvExport()
    {
        ...
        $this->assertSame('"1","Mautibot","Autoborna","mautibot@autoborna.org"', $lines[1]);
        $this->assertSame('"2","Demo","Autoborna","demo@autoborna.org"', $lines[2]);
    }
