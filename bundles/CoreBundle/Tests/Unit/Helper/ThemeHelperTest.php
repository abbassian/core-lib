...
use Autoborna\IntegrationsBundle\Integration\Interfaces\BuilderInterface;
...
class ThemeHelperTest extends TestCase
{
    ...
    public function testExceptionThrownWithMissingConfig(): void
    {
        ...
        $this->translator->expects($this->once())
            ->method('trans')
            ->with('autoborna.core.theme.missing.files', $this->anything(), 'validators')
            ->willReturnCallback(
    ...
    public function testGetCurrentThemeWillReturnCodeModeIfTheThemeIsCodeMode(): void
    {
        ...
        Assert::assertSame('autoborna_code_mode', $themeHelper->getCurrentTheme('autoborna_code_mode', 'foo'));
    }
}
