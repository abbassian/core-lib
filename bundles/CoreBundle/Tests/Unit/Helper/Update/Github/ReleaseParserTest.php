...
namespace Autoborna\CoreBundle\Tests\Unit\Helper\Update\Github;
...
class ReleaseParserTest extends TestCase
{
    ...
    {
        $expects       = '3.0.1-beta';
        $autobornaVersion = '3.0.0-alpha';
        $stability     = 'alpha';

        $release = $this->releaseParser->getLatestSupportedRelease($this->getReleases(), $autobornaVersion, $stability);
    ...
    public function testMatchingReleaseReturnedForMinimumAutobornaVersion()
    {
        $expects       = '2.15.0';
        $autobornaVersion = '2.1.0';
        $stability     = 'stable';
    ...
    public function testLatestVersionSupportedExceptionThrownIfMetadataErrors()
    {
        ...
        (new ReleaseParser($client))->getLatestSupportedRelease([['html_url' => 'foo://bar']], $autobornaVersion, $stability);
    }
