...
namespace Autoborna\CoreBundle\Tests\Unit\Loader\EnvVars;

use Autoborna\CoreBundle\Loader\EnvVars\SAMLEnvVars;
...
class SAMLEnvVarsTest extends TestCase
{
    ...
    public function testEntityIdIsSetToAutobornaByDefault()
    {
        $this->config->set('saml_idp_entity_id', '');
        ...
        $this->assertEquals('autoborna', $this->envVars->get('MAUTIC_SAML_ENTITY_ID'));
    }
