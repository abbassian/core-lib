...
namespace Autoborna\CoreBundle\Tests\Unit\Loader;
...
class ParameterLoaderTest extends TestCase
{
    public function testParametersAreLoaded(): void
    {
        ...
        $this->assertEquals('https://language-packs.autoborna.com/', $parameterBag->get('translations_fetch_url'));
        $this->assertEquals('https://language-packs.autoborna.com/', getenv('MAUTIC_TRANSLATIONS_FETCH_URL'));
