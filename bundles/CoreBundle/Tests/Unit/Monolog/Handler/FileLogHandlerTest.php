...
namespace Autoborna\CoreBundle\Tests\Unit\Monolog\Handler;

use Autoborna\CoreBundle\Helper\CoreParametersHelper;
use Autoborna\CoreBundle\Monolog\Handler\FileLogHandler;
...
class FileLogHandlerTest extends TestCase
{
    ...
    public function testPropertiesAreSetFromCoreParametersHelperWhenDebugModeEnabled(): void
    {
        ...
        $this->assertEquals('/var/logs/autoborna_test.php', $filename);
