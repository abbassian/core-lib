...
use Autoborna\CoreBundle\Update\Step\FinalizeUpdateStep;
...
class FinalizeUpdateStepTest extends AbstractStepTest
{
    ...
    public function testFinalizationCleansUpFiles()
    {
        ...
        $wrappingUpKey       = 'autoborna.core.update.step.wrapping_up';
        $updateSuccessfulKey = 'autoborna.core.update.update_successful';
