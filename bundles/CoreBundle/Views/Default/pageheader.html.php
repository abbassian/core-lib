...
<div class="page-header">
    <div class="box-layout">
        <div class="col-xs-5 col-sm-6 col-md-5 va-m">
            ...
            <?php echo $view['content']->getCustomContent('page.header.left', $autobornaTemplateVars); ?>
        </div>
        <div class="col-xs-7 col-sm-6 col-md-7 va-m">
            <div class="toolbar text-right" id="toolbar">
                ...
                <?php echo $view['content']->getCustomContent('page.header.right', $autobornaTemplateVars); ?>
            </div>
