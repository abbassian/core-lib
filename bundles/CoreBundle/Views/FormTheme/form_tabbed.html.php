...
$view->extend('AutobornaCoreBundle:FormTheme:form.html.php');
        ...
        <div class="col-md-<?php echo $hasRightColumn ? 9 : 12; ?> height-auto bg-white">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <?php echo $aboveTabs; ?>
                    <?php echo $view['content']->getCustomContent('tabs.above', $autobornaTemplateVars); ?>
                    <?php echo $view->render('AutobornaCoreBundle:Helper:tabs.html.php', ['tabs' => $tabs]); ?>
                    ...
                    <?php echo $belowTabs; ?>
                    <?php echo $view['content']->getCustomContent('tabs.below', $autobornaTemplateVars); ?>
                </div>
            </div>
        </div>
