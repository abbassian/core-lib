...
if (!isset($translationBase)) {
    ...
    $translationBase = 'autoborna.'.$langVar;
}
...
if (isset($route) && !isset($actionRoute)) {
    ...
    $actionRoute = '';
    if (isset($routeBase)) {
        $actionRoute = 'autoborna_'.str_replace('autoborna_', '', $routeBase).'_action';
    }
}
if (!isset($indexRoute)) {
    $indexRoute = '';
    if (isset($routeBase)) {
        $indexRoute = 'autoborna_'.str_replace('autoborna_', '', $routeBase).'_index';
    }
}
