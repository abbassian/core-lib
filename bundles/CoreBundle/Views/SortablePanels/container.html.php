...
if (!isset($panelTemplate)) {
    $panelTemplate = 'AutobornaCoreBundle:SortablePanels:panel.html.php';
}
    ...
    <div id="<?php echo $containerId; ?>" class="col-sm-12 sortable-panels" data-index="<?php echo count($panels); ?>">
        ...
        <?php if (!count($panels)): ?>
            <div class="alert alert-info col-md-<?php echo $colSize; ?> sortable-panel-placeholder">
                <p>
                    <?php echo $view['translator']->trans((isset($noPanelMessage) ? $noPanelMessage : 'autoborna.channel.form.additem')); ?>
                </p>
            </div>
        <?php endif; ?>
        </div>
