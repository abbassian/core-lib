        ...
        <table class="table table-hover table-striped table-bordered <?php echo $sessionVar; ?>-list">
            ...
            <tr>
                ...
                if (isset($listHeaders)):
                    foreach ($listHeaders as $header):
                        ...
                        echo $view->render('AutobornaCoreBundle:Helper:tableheader.html.php', $header);
                    endforeach;
                endif;
                ...
                ?>
                <?php echo $view['content']->getCustomContent('list.headers', $autobornaTemplateVars); ?>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($items as $item): ?>
                <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <a data-toggle="ajax" href="<?php echo $view['router']->path(
                                    ...
                                    <?php echo $view['content']->getCustomContent('list.name', $autobornaTemplateVars); ?>
                                </a>
                            </div>
                    ...
                    <?php endif; ?>
                    <?php echo $view['content']->getCustomContent('list.columns', $autobornaTemplateVars); ?>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
