...
class AjaxController extends CommonAjaxController
{
    ...
    protected function viewingVisitorsAction(Request $request)
    {
        ...
        /** @var \Autoborna\PageBundle\Entity\PageRepository $pageRepository */
        $pageRepository               = $this->get('doctrine.orm.entity_manager')->getRepository('AutobornaPageBundle:Hit');
    ...
    protected function updateWidgetFormAction(Request $request)
    {
        ...
        $formHtml = $this->render('AutobornaDashboardBundle::Widget\\form.html.php',
    ...
    public function deleteAction(Request $request)
    {
        ...
        // if (!$this->get('autoborna.security')->isGranted('dashobard:widgets:delete')) {
        //     return $this->accessDenied();
        // }

        /** @var \Autoborna\DashboardBundle\Model\DashboardModel $model */
