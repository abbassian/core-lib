...
namespace Autoborna\DashboardBundle\Model;
...
class DashboardModel extends FormModel
{
    ...
    {
        return $this->em->getRepository('AutobornaDashboardBundle:Widget');
    }
    ...
    public function generateDescription()
    {
        return $this->translator->trans(
            'autoborna.dashboard.generated_by',
            [
    ...
    public function saveEntity($entity, $unlock = true)
    {
        ...
        if (!$entity->getName()) {
            $entity->setName($this->translator->trans('autoborna.widget.'.$entity->getType()));
        }
    ...
    public function getDefaultFilter(): array
    {
        ...
        $today    = new \DateTime();
        $dateFrom = new \DateTime($this->session->get('autoborna.daterange.form.from', $dateRangeStart->format('Y-m-d 00:00:00')));
        $dateTo   = new \DateTime($this->session->get('autoborna.daterange.form.to', $today->format('Y-m-d 23:59:59')));
