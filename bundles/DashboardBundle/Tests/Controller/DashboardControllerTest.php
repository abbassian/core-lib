...
use Autoborna\DashboardBundle\Controller\DashboardController;
use Autoborna\DashboardBundle\Dashboard\Widget;
...
class DashboardControllerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSaveWithPostNotAjaxWillCallAccessDenied(): void
    {
        ...
        $this->translatorMock->expects($this->once())
            ->method('trans')
            ->with('autoborna.core.url.error.401');
    ...
    public function testSaveWithPostAjaxWillSave(): void
    {
        ...
        $this->translatorMock->expects($this->once())
            ->method('trans')
            ->with('autoborna.dashboard.notice.save');
    ...
    public function testSaveWithPostAjaxWillNotBeAbleToSave(): void
    {
        ...
        $this->translatorMock->expects($this->once())
            ->method('trans')
            ->with('autoborna.dashboard.error.save');
    ...
    public function testWidgetNotFound(): void
    {
        ...
        $this->containerMock->expects(self::once())
            ->method('get')
            ->with('autoborna.dashboard.widget')
    ...
    {
        $widgetId        = '1';
        $widget          = new \Autoborna\DashboardBundle\Entity\Widget();
