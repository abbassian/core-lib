...
use Autoborna\CoreBundle\Entity\FiltersEntityTrait;
use Autoborna\CoreBundle\Entity\FormEntity;
use Autoborna\CoreBundle\Entity\TranslationEntityInterface;
use Autoborna\CoreBundle\Entity\TranslationEntityTrait;
use Autoborna\CoreBundle\Entity\VariantEntityInterface;
use Autoborna\CoreBundle\Entity\VariantEntityTrait;
...
class DynamicContent extends FormEntity implements VariantEntityInterface, TranslationEntityInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('dynamic_content')
            ...
            ->setCustomRepositoryClass('Autoborna\DynamicContentBundle\Entity\DynamicContentRepository')
    ...
    {
        $metadata->addPropertyConstraint('name', new NotBlank(['message' => 'autoborna.core.name.required']));
                ...
                if (!$dwc->getIsCampaignBased()) {
                    ...
                    $violations = $validator->validate(
                        ...
                        [
                            new NotBlank(
                                [
                                    'message' => 'autoborna.dynamicContent.slot_name.notblank',
                                ]
                            ),
                        ]
                    );
                    ...
                    $violations = $validator->validate(
                        ...
                        [
                            new Count(
                                [
                                    'minMessage' => 'autoborna.dynamicContent.filter.options.empty',
                                    'min'        => 1,
                                ]
                            ),
                        ]
    ...
    /**
     * @return \Autoborna\CategoryBundle\Entity\Category
     */
    ...
    /**
     * @param \Autoborna\CategoryBundle\Entity\Category $category
     *
     * @return $this
     */
