...
namespace Autoborna\EmailBundle\Controller\Api;
...
class EmailApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->entityClass      = 'Autoborna\EmailBundle\Entity\Email';
    ...
    public function replyAction($trackingHash)
    {
        ...
        $replyService = $this->get('autoborna.message.processor.replier');

        /** @var RandomHelperInterface $randomHelper */
        $randomHelper = $this->get('autoborna.helper.random');
