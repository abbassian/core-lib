...
class ParseEmailEvent extends Event
{
     ...
     *
     * @return \Autoborna\EmailBundle\MonitoredEmail\Message[]
     */
     ...
     * @param string $criteria   Should be a string using combinations of Autoborna\EmailBundle\MonitoredEmail\Mailbox::CRITERIA_* constants
