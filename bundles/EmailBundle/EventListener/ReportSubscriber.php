...
class ReportSubscriber implements EventSubscriberInterface
{
    ...
    const DNC_COLUMNS = [
        'unsubscribed' => [
            'alias'   => 'unsubscribed',
            'label'   => 'autoborna.email.report.unsubscribed',
            'type'    => 'string',
        ...
        'unsubscribed_ratio' => [
            ...
            'label'   => 'autoborna.email.report.unsubscribed_ratio',
            'type'    => 'string',
        ...
        'bounced' => [
            'alias'   => 'bounced',
            'label'   => 'autoborna.email.report.bounced',
            'type'    => 'string',
        ...
        'bounced_ratio' => [
            'alias'   => 'bounced_ratio',
            'label'   => 'autoborna.email.report.bounced_ratio',
            'type'    => 'string',
    ...
    const EMAIL_STATS_COLUMNS = [
        self::EMAIL_STATS_PREFIX.'.email_address' => [
            'label' => 'autoborna.email.report.stat.email_address',
            'type'  => 'email',
        ],
        self::EMAIL_STATS_PREFIX.'.date_sent' => [
            'label'          => 'autoborna.email.report.stat.date_sent',
            'type'           => 'datetime',
            'groupByFormula' => 'DATE('.self::EMAIL_STATS_PREFIX.'.date_sent)',
        ],
        self::EMAIL_STATS_PREFIX.'.is_read' => [
            'label' => 'autoborna.email.report.stat.is_read',
            'type'  => 'bool',
        ],
        self::EMAIL_STATS_PREFIX.'.is_failed' => [
            'label' => 'autoborna.email.report.stat.is_failed',
            'type'  => 'bool',
        ],
        self::EMAIL_STATS_PREFIX.'.viewed_in_browser' => [
            'label' => 'autoborna.email.report.stat.viewed_in_browser',
            'type'  => 'bool',
        ],
        self::EMAIL_STATS_PREFIX.'.date_read' => [
            'label'          => 'autoborna.email.report.stat.date_read',
            'type'           => 'datetime',
            'groupByFormula' => 'DATE('.self::EMAIL_STATS_PREFIX.'.date_read)',
        ],
        self::EMAIL_STATS_PREFIX.'.retry_count' => [
            'label' => 'autoborna.email.report.stat.retry_count',
            'type'  => 'int',
        ],
    ...
    const EMAIL_VARIANT_COLUMNS = [
        self::EMAIL_VARIANT_PREFIX.'.id' => [
            'label' => 'autoborna.email.report.variant_parent_id',
            'type'  => 'int',
        ],
        self::EMAIL_VARIANT_PREFIX.'.subject' => [
            'label' => 'autoborna.email.report.variant_parent_subject',
            'type'  => 'string',
        ],
    ];
    ...
    const CLICK_COLUMNS = [
        'hits' => [
            'alias'   => 'hits',
            'label'   => 'autoborna.email.report.hits_count',
            'type'    => 'string',
            'formula' => 'IFNULL('.self::CLICK_PREFIX.'.hits, 0)',
        ],
        'unique_hits' => [
            'alias'   => 'unique_hits',
            'label'   => 'autoborna.email.report.unique_hits_count',
            'type'    => 'string',
            'formula' => 'IFNULL('.self::CLICK_PREFIX.'.unique_hits, 0)',
        ],
        'hits_ratio' => [
            'alias'   => 'hits_ratio',
            'label'   => 'autoborna.email.report.hits_ratio',
            'type'    => 'string',
        ...
        'unique_ratio' => [
            'alias'   => 'unique_ratio',
            'label'   => 'autoborna.email.report.unique_ratio',
            'type'    => 'string',
    ...
    public function onReportBuilder(ReportBuilderEvent $event)
    {
        ...
        $columns = [
            ...
            $prefix.'read_count' => [
                'label' => 'autoborna.email.report.read_count',
                'type'  => 'int',
            ],
            'read_ratio' => [
                'alias'   => 'read_ratio',
                'label'   => 'autoborna.email.report.read_ratio',
                'type'    => 'string',
                'formula' => 'IFNULL(ROUND(('.$prefix.'read_count/'.$prefix.'sent_count)*100, 1), \'0.0\')',
                'suffix'  => '%',
            ],
            $prefix.'sent_count' => [
                'label' => 'autoborna.email.report.sent_count',
                'type'  => 'int',
            ],
            $prefix.'revision' => [
                'label' => 'autoborna.email.report.revision',
                'type'  => 'int',
            ],
            $prefix.'variant_start_date' => [
                'label'          => 'autoborna.email.report.variant_start_date',
                'type'           => 'datetime',
                'groupByFormula' => 'DATE('.$prefix.'variant_start_date)',
            ],
            $prefix.'variant_sent_count' => [
                'label' => 'autoborna.email.report.variant_sent_count',
                'type'  => 'int',
            ],
            $prefix.'variant_read_count' => [
                'label' => 'autoborna.email.report.variant_read_count',
                'type'  => 'int',
            ],
        ];
        ...
        $columns = array_merge(
            $columns,
            $event->getStandardColumns($prefix, [], 'autoborna_email_action'),
        ...
        $data = [
            'display_name' => 'autoborna.email.emails',
            'columns'      => $columns,
        ];
        $event->addTable(self::CONTEXT_EMAILS, $data);
        $context = self::CONTEXT_EMAILS;
        $event->addGraph($context, 'pie', 'autoborna.email.graph.pie.read.ingored.unsubscribed.bounced');
        ...
        if ($event->checkContext(self::CONTEXT_EMAIL_STATS)) {
            ...
            $columns['is_hit'] = [
                'alias'   => 'is_hit',
                'label'   => 'autoborna.email.report.is_hit',
                'type'    => 'bool',
            ...
            $columns['read_delay'] = [
                'alias'   => 'read_delay',
                'label'   => 'autoborna.email.report.read.delay',
                'type'    => 'string',
                'formula' => 'IF(es.date_read IS NOT NULL, TIMEDIFF(es.date_read, es.date_sent), \'-\')',
            ];

            $data = [
                'display_name' => 'autoborna.email.stats.report.table',
                'columns'      => array_merge(
                    $columns,
            ...
            $event->addGraph($context, 'line', 'autoborna.email.graph.line.stats');
            $event->addGraph($context, 'pie', 'autoborna.email.graph.pie.ignored.read.failed');
            $event->addGraph($context, 'table', 'autoborna.email.table.most.emails.sent');
            $event->addGraph($context, 'table', 'autoborna.email.table.most.emails.read');
            $event->addGraph($context, 'table', 'autoborna.email.table.most.emails.read.percent');
            $event->addGraph($context, 'table', 'autoborna.email.table.most.emails.unsubscribed');
            $event->addGraph($context, 'table', 'autoborna.email.table.most.emails.bounced');
            $event->addGraph($context, 'table', 'autoborna.email.table.most.emails.failed');
        }
    }
    ...
    public function onReportGraphGenerate(ReportGraphEvent $event)
    {
        ...
        if ($event->checkContext(self::CONTEXT_EMAILS) && !in_array('autoborna.email.graph.pie.read.ingored.unsubscribed.bounced', $graphs)) {
            return;
        }
        ...
        foreach ($graphs as $g) {
            ...
            switch ($g) {
                case 'autoborna.email.graph.line.stats':
                    ...
                    $chart->setDataset($options['translator']->trans('autoborna.email.sent.emails'), $sends);
                    $chart->setDataset($options['translator']->trans('autoborna.email.read.emails'), $reads);
                    $chart->setDataset($options['translator']->trans('autoborna.email.failed.emails'), $failes);
                    $data         = $chart->render();
                    $data['name'] = $g;
                ...
                case 'autoborna.email.graph.pie.ignored.read.failed':
                    $counts = $this->statRepository->getIgnoredReadFailed($queryBuilder);
                    $chart  = new PieChart();
                    $chart->setDataset($options['translator']->trans('autoborna.email.read.emails'), $counts['read']);
                    $chart->setDataset($options['translator']->trans('autoborna.email.failed.emails'), $counts['failed']);
                    $chart->setDataset(
                        $options['translator']->trans('autoborna.email.ignored.emails'),
                        $counts['ignored']
                    );
                    $event->setGraph(
                        $g,
                ...
                case 'autoborna.email.graph.pie.read.ingored.unsubscribed.bounced':
                    ...
                    $chart  = new PieChart();
                    $chart->setDataset(
                        $options['translator']->trans('autoborna.email.stat.read'),
                        $counts['read_count'] ?? 0
                    );
                    $chart->setDataset(
                        $options['translator']->trans('autoborna.email.graph.pie.ignored.read.failed.ignored'),
                        (($counts['sent_count'] ?? 0) - ($counts['read_count'] ?? 0))
                    );
                    $chart->setDataset(
                        $options['translator']->trans('autoborna.email.unsubscribed'),
                        $counts['unsubscribed'] ?? 0
                    );
                    $chart->setDataset(
                        $options['translator']->trans('autoborna.email.bounced'),
                        $counts['bounced'] ?? 0
                    );
                ...
                case 'autoborna.email.table.most.emails.sent':
                    ...
                    $graphData['link']      = 'autoborna_email_action';
                    $event->setGraph($g, $graphData);
                    break;

                case 'autoborna.email.table.most.emails.read':
                    $this->joinEmailsTableIfMissing($queryBuilder, $event);
                ...
                case 'autoborna.email.table.most.emails.failed':
                    $this->joinEmailsTableIfMissing($queryBuilder, $event);
                    $queryBuilder->select(
                ...
                case 'autoborna.email.table.most.emails.unsubscribed':
                    $this->joinEmailsTableIfMissing($queryBuilder, $event);
                ...
                case 'autoborna.email.table.most.emails.bounced':
                    $this->joinEmailsTableIfMissing($queryBuilder, $event);
                    $this->addDNCTableForEmailStats($queryBuilder);
                    $queryBuilder->select(
                ...
                case 'autoborna.email.table.most.emails.read.percent':
                    $this->joinEmailsTableIfMissing($queryBuilder, $event);
