...
use Autoborna\CoreBundle\Form\Type\StandAloneButtonType;
...
class ConfigType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'autoborna.email.config.unsubscribe_text',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.unsubscribe_text.tooltip',
                ],
                'required'   => false,
                'data'       => (array_key_exists('unsubscribe_text', $options['data']) && !empty($options['data']['unsubscribe_text']))
                    ? $options['data']['unsubscribe_text']
                    : $this->translator->trans(
                        'autoborna.email.unsubscribe.text',
                        ['%link%' => '|URL|']
                    ),
            ]
        );
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'autoborna.email.config.webview_text',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.webview_text.tooltip',
                ],
                'required'   => false,
                'data'       => (array_key_exists('webview_text', $options['data']) && !empty($options['data']['webview_text']))
                    ? $options['data']['webview_text']
                    : $this->translator->trans(
                        'autoborna.email.webview.text',
                        ['%link%' => '|URL|']
                    ),
            ]
        );
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'autoborna.email.config.unsubscribe_message',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.unsubscribe_message.tooltip',
                ],
                'required'   => false,
                'data'       => (array_key_exists('unsubscribe_message', $options['data']) && !empty($options['data']['unsubscribe_message']))
                    ...
                    : $this->translator->trans(
                        'autoborna.email.unsubscribed.success',
                        [
                            '%resubscribeUrl%' => '|URL|',
                            '%email%'          => '|EMAIL|',
                        ]
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'autoborna.email.config.resubscribe_message',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.resubscribe_message.tooltip',
                ],
                'required'   => false,
                'data'       => (array_key_exists('resubscribe_message', $options['data']) && !empty($options['data']['resubscribe_message']))
                    ...
                    : $this->translator->trans(
                        'autoborna.email.resubscribed.success',
                        [
                            '%unsubscribeUrl%' => '|URL|',
                            '%email%'          => '|EMAIL|',
                        ]
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'autoborna.email.config.default_signature_text',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.default_signature_text.tooltip',
                ],
                'required'   => false,
                'data'       => (!empty($options['data']['default_signature_text']))
                    ? $options['data']['default_signature_text']
                    : $this->translator->trans(
                        'autoborna.email.default.signature',
                        [
                            '%from_name%' => '|FROM_NAME|',
                        ]
                    ),
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'       => 'autoborna.email.config.mailer.from.name',
                'label_attr'  => ['class' => 'control-label'],
                'attr'        => [
                    'class'    => 'form-control',
                    'tooltip'  => 'autoborna.email.config.mailer.from.name.tooltip',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'       => 'autoborna.email.config.mailer.from.email',
                'label_attr'  => ['class' => 'control-label'],
                'attr'        => [
                    'class'    => 'form-control',
                    'tooltip'  => 'autoborna.email.config.mailer.from.email.tooltip',
                    'onchange' => 'Autoborna.disableSendTestEmailButton()',
                ],
                'constraints' => [
                    new NotBlank(
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.return.path',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'    => 'form-control',
                    'tooltip'  => 'autoborna.email.config.mailer.return.path.tooltip',
                    'onchange' => 'Autoborna.disableSendTestEmailButton()',
                ],
                'required'   => false,
            ]
        ...
        $builder->add(
            ...
            [
                ...
                'label'             => 'autoborna.email.config.mailer.transport',
                'required'          => false,
                'attr'              => [
                    'class'    => 'form-control',
        ...
        $builder->add(
            ...
            [
                'label'      => 'autoborna.email.config.mailer.convert.embed.images',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.mailer.convert.embed.images.tooltip',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.mailer.append.tracking.pixel',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.mailer.append.tracking.pixel.tooltip',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.mailer.disable.trackable.urls',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.mailer.disable.trackable.urls.tooltip',
                ],
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.host',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.port',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            [
                ...
                'label'       => 'autoborna.email.config.mailer.auth.mode',
                'label_attr'  => ['class' => 'control-label'],
                'required'    => false,
                'attr'        => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.user',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'data-show-on' => '{
        ...
        $builder->add(
            ...
            PasswordType::class,
            [
                'label'      => 'autoborna.email.config.mailer.password',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
        ...
        $builder->add(
            ...
            [
                ...
                'label'       => 'autoborna.email.config.mailer.encryption',
                'required'    => false,
                'attr'        => [
                    'class'        => 'form-control',
                    'data-show-on' => $smtpServiceShowConditions,
        ...
        $builder->add(
            ...
            [
                'label'    => 'autoborna.email.config.mailer.transport.test_connection',
                'required' => false,
                'attr'     => [
                    'class'   => 'btn btn-success',
                    'onclick' => 'Autoborna.testEmailServerConnection()',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            StandAloneButtonType::class,
            [
                'label'    => 'autoborna.email.config.mailer.transport.test_send',
                'required' => false,
                'attr'     => [
                    'class'   => 'btn btn-info',
                    'onclick' => 'Autoborna.sendTestEmail()',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.mailer.mailjet.sandbox',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'tooltip'      => 'autoborna.email.config.mailer.mailjet.sandbox',
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'       => 'autoborna.email.config.mailer.mailjet.sandbox.mail',
                'label_attr'  => ['class' => 'control-label'],
                'attr'        => [
                    'class'        => 'form-control',
                    'tooltip'      => 'autoborna.email.config.mailer.mailjet.sandbox.mail',
                    'data-show-on' => '{"config_emailconfig_mailer_transport":['.$this->transportType->getMailjetService().']}',
        ...
        $builder->add(
            ...
            [
                ...
                'label'       => 'autoborna.email.config.mailer.spool.type',
                'label_attr'  => ['class' => 'control-label'],
                'required'    => false,
                'attr'        => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.mailer.spool.type.tooltip',
                ],
                'placeholder' => false,
            ]
        );
        ...
        $builder->add(
            ...
            [
                ...
                'attr'            => [
                    'tooltip'  => 'autoborna.email.custom_headers.config.tooltip',
                    'onchange' => 'Autoborna.disableSendTestEmailButton()',
                ],
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.spool.path',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'data-hide-on' => $spoolConditions,
                    'tooltip'      => 'autoborna.email.config.mailer.spool.path.tooltip',
                ],
                'required'   => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.spool.msg.limit',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'data-hide-on' => $spoolConditions,
                    'tooltip'      => 'autoborna.email.config.mailer.spool.msg.limit.tooltip',
                ],
                'required'   => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.spool.time.limit',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'data-hide-on' => $spoolConditions,
                    'tooltip'      => 'autoborna.email.config.mailer.spool.time.limit.tooltip',
                ],
                'required'   => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.spool.recover.timeout',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'data-hide-on' => $spoolConditions,
                    'tooltip'      => 'autoborna.email.config.mailer.spool.recover.timeout.tooltip',
                ],
                'required'   => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.email.config.mailer.spool.clear.timeout',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'        => 'form-control',
                    'data-hide-on' => $spoolConditions,
                    'tooltip'      => 'autoborna.email.config.mailer.spool.clear.timeout.tooltip',
                ],
                'required'   => false,
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.mailer.is.owner',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.mailer.is.owner.tooltip',
                ],
        ...
        $builder->add(
            ...
            [
                'scale'      => 0,
                'label'      => 'autoborna.lead.list.frequency.number',
                'label_attr' => ['class' => 'control-label'],
                'required'   => false,
                'attr'       => [
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.show.contact.segments',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.show.contact.segments.tooltip',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.show.preference.options',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.show.preference.options.tooltip',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.show.contact.frequency',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.show.contact.frequency.tooltip',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.show.contact.pause.dates',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.show.contact.pause.dates.tooltip',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.show.contact.categories',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.show.contact.categories.tooltip',
                ],
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label'      => 'autoborna.email.config.show.contact.preferred.channels',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.email.config.show.contact.preferred.channels',
                ],
