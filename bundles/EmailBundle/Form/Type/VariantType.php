...
class VariantType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('weight',
            IntegerType::class,
            [
                'label'      => 'autoborna.core.ab_test.form.traffic_weight',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.core.ab_test.form.traffic_weight.help',
                ],
                'constraints' => [
                    new NotBlank(
                        ['message' => 'autoborna.email.variant.weight.notblank']
                    ),
                ],
            ]
        );
        ...
        if (!empty($abTestWinnerCriteria)) {
            ...
            $builder->add(
                'winnerCriteria',
                ChoiceType::class, [
                    'label'             => 'autoborna.core.ab_test.form.winner',
                    'label_attr'        => ['class' => 'control-label'],
                    'attr'              => [
                        'class'    => 'form-control',
                        'onchange' => 'Autoborna.getAbTestWinnerForm(\'email\', \'emailform\', this);',
                    ],
                    'expanded'    => false,
                    'multiple'    => false,
                    'choices'     => $choices,
