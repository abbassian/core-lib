...
use Autoborna\EmailBundle\Exception\MailboxException;
use Autoborna\EmailBundle\MonitoredEmail\Exception\NotConfiguredException;
use stdClass;
...
class Mailbox
{
    ...
    public function getListingFolders()
    {
        if (!$this->isConfigured()) {
            throw new NotConfiguredException('autoborna.email.config.monitored_email.not_configured');
        }
