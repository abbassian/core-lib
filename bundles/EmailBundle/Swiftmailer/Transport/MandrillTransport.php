...
class MandrillTransport extends AbstractTokenHttpTransport implements CallbackTransportInterface
{
    ...
    protected function getPayload()
    {
        ...
        $autobornaTokens = $mandrillMergeVars = $mandrillMergePlaceholders = [];

        // Mandrill uses *|PLACEHOLDER|* for tokens so Autoborna's need to be replaced
        if (!empty($metadata)) {
        ...
        $message = $this->messageToArray($autobornaTokens, $mandrillMergePlaceholders, true);
