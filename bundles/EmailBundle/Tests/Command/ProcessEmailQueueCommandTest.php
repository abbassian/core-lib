...
namespace Autoborna\EmailBundle\Tests\Command;

use Autoborna\CoreBundle\Helper\CoreParametersHelper;
use Autoborna\EmailBundle\Command\ProcessEmailQueueCommand;
...
class ProcessEmailQueueCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCommandWhenQueueIsDisabled()
    {
        ...
        $this->assertSame("Autoborna is not set to queue email.\n", $output->fetch());
    }
    ...
    public function testCommandWhenQueueIsEnabled()
    {
        ...
        $tmpSpoolDir            = sys_get_temp_dir().'/autobornaSpoolTestDir';
        ...
        $this->coreParametersHelper->method('get')
            ->withConsecutive(
                ['mailer_spool_type'],
                ['autoborna.mailer_spool_path'],
                ['autoborna.mailer_spool_msg_limit']
            )
