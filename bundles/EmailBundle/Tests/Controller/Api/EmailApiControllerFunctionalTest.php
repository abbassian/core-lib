...
namespace Autoborna\EmailBundle\Tests\Controller\Api;
...
class EmailApiControllerFunctionalTest extends AutobornaMysqlTestCase
{
    ...
    {
        $mailHelper = self::$container->get('autoborna.helper.mailer');
    ...
    public function testReplyAction(): void
    {
        ...
        $statRepository = self::$container->get('autoborna.email.repository.stat');
