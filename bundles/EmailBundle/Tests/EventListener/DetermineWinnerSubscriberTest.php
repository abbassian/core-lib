...
use Autoborna\EmailBundle\EventListener\DetermineWinnerSubscriber;
...
class DetermineWinnerSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testOnDetermineOpenRateWinner()
    {
        ...
        $this->translator->method('trans')
            ->withConsecutive(
                ['autoborna.email.abtest.label.opened'],
                ['autoborna.email.abtest.label.sent'],
                ['autoborna.email.abtest.label.opened'],
                ['autoborna.email.abtest.label.sent'],
                ['autoborna.email.abtest.label.opened'],
                ['autoborna.email.abtest.label.sent'])
    ...
    public function testOnDetermineOClickthroughRateWinner()
    {
        ...
        $this->translator->method('trans')
            ->withConsecutive(
                ['autoborna.email.abtest.label.clickthrough'],
                ['autoborna.email.abtest.label.opened'],
                ['autoborna.email.abtest.label.clickthrough'],
                ['autoborna.email.abtest.label.opened'],
                ['autoborna.email.abtest.label.clickthrough'],
