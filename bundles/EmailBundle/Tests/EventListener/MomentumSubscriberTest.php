...
use Autoborna\EmailBundle\EventListener\MomentumSubscriber;
...
class MomentumSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testOnMomentumWebhookRequestWhenQueueIsEnabled()
    {
        ...
        $key                   = 'Autoborna\EmailBundle\Swiftmailer\Transport\MomentumTransport:webhook_request:5b43832134cfb0.36545510';
