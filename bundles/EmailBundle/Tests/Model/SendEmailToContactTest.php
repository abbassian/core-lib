...
use Autoborna\EmailBundle\Entity\CopyRepository;
...
use Autoborna\EmailBundle\Tests\Helper\Transport\BatchTransport;
...
class SendEmailToContactTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::setEmail()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::setContact()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::send()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::finalFlush()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::failContact()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::getFailedContacts()
     */
    ...
    public function testBadEmailDoesNotCauseBatchQueueMaxExceptionOnSubsequentContacts()
    {
        ...
        $emailMock->method('getFromAddress')
            ->willReturn('test@autoborna.com');

        // Use our test token transport limiting to 1 recipient per queue
        $transport = new BatchTransport(false, 1);
        $mailer    = new \Swift_Mailer($transport);

        // Mock factory to ensure that queue mode is handled until MailHelper is refactored completely away from AutobornaFactory
        $factoryMock = $this->getMockBuilder(AutobornaFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
     ...
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::send()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::failContact()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::createContactStatEntry()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::getFailedContacts()
     */
     ...
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::failContact()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::getFailedContacts()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::upEmailSentCount()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::downEmailSentCount()
     * @covers \Autoborna\EmailBundle\Model\SendEmailToContact::getSentCounts()
     */
    ...
    public function testThatInvalidBccFailureIsHandled()
    {
        ...
        $mockFactory = $this->getMockBuilder(AutobornaFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $emailMock
            ...
            ->willReturn('test@autoborna.com; test@autoborna.com');
        ...
        $this->expectExceptionMessage('Address in mailbox given [test@autoborna.com; test@autoborna.com] does not comply with RFC 2822, 3.6.2.');
