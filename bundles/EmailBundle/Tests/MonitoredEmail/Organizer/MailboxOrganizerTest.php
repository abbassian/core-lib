...
use Autoborna\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer;
...
class MailboxOrganizerTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers  \Autoborna\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::organize()
     * @covers  \Autoborna\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainer()
     * @covers  \Autoborna\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainers()
     */
     ...
     * @covers  \Autoborna\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainer()
     * @covers  \Autoborna\EmailBundle\MonitoredEmail\Organizer\MailboxOrganizer::getContainers()
     * @covers  \Autoborna\EmailBundle\Event\ParseEmailEvent::setCriteriaRequest()
     * @covers  \Autoborna\EmailBundle\Event\ParseEmailEvent::getCriteriaRequests()
     */
     ...
     * @covers  \Autoborna\EmailBundle\Event\ParseEmailEvent::setCriteriaRequest()
     * @covers  \Autoborna\EmailBundle\Event\ParseEmailEvent::getCriteriaRequests()
     * @covers  \Autoborna\EmailBundle\Event\ParseEmailEvent::getMarkAsSeenInstructions()
     */
