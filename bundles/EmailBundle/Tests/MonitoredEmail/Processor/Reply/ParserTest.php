...
namespace Autoborna\EmailBundle\Tests\MonitoredEmail\Processor\Reply;

use Autoborna\EmailBundle\MonitoredEmail\Exception\ReplyNotFound;
use Autoborna\EmailBundle\MonitoredEmail\Message;
use Autoborna\EmailBundle\MonitoredEmail\Processor\Reply\Parser;
use Autoborna\EmailBundle\MonitoredEmail\Processor\Reply\RepliedEmail;
...
class ParserTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @covers  \Autoborna\EmailBundle\MonitoredEmail\Processor\Reply\Parser::parse()
     * @covers  \Autoborna\EmailBundle\MonitoredEmail\Processor\Reply\RepliedEmail::getStatHash()
     */
