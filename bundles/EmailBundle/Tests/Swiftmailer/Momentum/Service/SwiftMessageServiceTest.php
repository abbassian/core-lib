...
namespace Autoborna\EmailBundle\Tests\Swiftmailer\Momentum\Service;

use Autoborna\EmailBundle\Swiftmailer\Message\AutobornaMessage;
use Autoborna\EmailBundle\Swiftmailer\Momentum\Service\SwiftMessageService;
...
class SwiftMessageServiceTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testTransformToTransmission(AutobornaMessage $autobornaMessage, $expectedTransmissionJson)
    {
        $service         = new SwiftMessageService();
        $transmissionDTO = $service->transformToTransmission($autobornaMessage);
    ...
    {
        $autobornaMessage = new AutobornaMessage();

        $autobornaMessage->setSubject('Test subject')
