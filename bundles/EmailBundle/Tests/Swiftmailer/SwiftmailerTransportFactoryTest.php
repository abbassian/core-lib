...
namespace Autoborna\EmailBundle\Tests\Swiftmailer;

use Autoborna\EmailBundle\Swiftmailer\SwiftmailerTransportFactory;
...
class SwiftmailerTransportFactoryTest extends TestCase
{
    ...
    public function testServiceIsFoundAndReturned()
    {
        ...
        $transport = 'autoborna.transport.sparkpost';
