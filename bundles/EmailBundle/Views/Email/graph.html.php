...
if ('list' == $email->getEmailType()) {
    $label = 'autoborna.email.lead.list.comparison';
    $type  = 'bar';
} else {
    $label = 'autoborna.email.stats';
    $type  = 'line';
}
$dateFrom    = $dateRangeForm->children['date_from']->vars['data'];
$dateTo      = $dateRangeForm->children['date_to']->vars['data'];
$actionRoute = $view['router']->path('autoborna_email_action',
    [
        'objectAction' => 'view',
...
<div class="pa-md">
    ...
    echo ' disabled';
                        ...
                        <?php echo $view['translator']->trans('autoborna.email.variant.graph.variant'); ?>
                    </a>
                </span>
                </span> | </span>
                <span>
    ...
    echo ' disabled';
                        ...
                        <?php echo $view['translator']->trans('autoborna.email.variant.graph.all'); ?>
                    </a>
                </span>
            </div>
            <?php endif; ?>
            <div class="panel">
                ...
                <div class="row">
                    <div class="pt-0 pl-15 pb-10 pr-15 col-xs-6">
                        <?php echo $view->render('AutobornaCoreBundle:Helper:chart.html.php', ['chartData' => $stats, 'chartType' => $type, 'chartHeight' => 300]); ?>
                    </div>
                    <div class="pt-0 pl-15 pb-10 pr-15 col-xs-6">
                        <?php echo $view->render('AutobornaCoreBundle:Helper:chart.html.php', ['chartData' => $statsDevices, 'chartType' => 'horizontal-bar', 'chartHeight' => 300]); ?>
                    </div>
                </div>
            </div>
        </div>
