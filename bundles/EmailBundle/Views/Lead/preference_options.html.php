    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1 class="panel-title"><?php echo $view['translator']->trans('autoborna.lead.message.preferences'); ?></h1>
            </div>
            <div class="panel-body">
                <div class="the-price">
                    <h4> <?php echo $leadName; ?></h4>
                    <small> <?php
                        echo $view['translator']->trans('autoborna.lead.message.preferences.descr'); ?></small>
                </div>
                        ...
                        <td>
                            <div id="frequency_<?php echo $channel->value; ?>" class="text-left row">
                                ...
                                <?php if ($showContactPauseDates):?>
                                    <div class="col-md-6">
                                        <label class="text-muted"><?php echo $view['translator']->trans('autoborna.lead.frequency.dates.label'); ?></label>
