...
class LeadSubscriber implements EventSubscriberInterface
{
    ...
    public function onTimelineGenerate(LeadTimelineEvent $event)
    {
        ...
        $eventTypeName = $this->translator->trans('autoborna.form.event.submitted');
            ...
            foreach ($rows['results'] as $row) {
                ...
                $event->addEvent(
                    [
                        ...
                        'eventLabel' => [
                            'label' => $form->getName(),
                            'href'  => $this->router->generate('autoborna_form_action', ['objectAction' => 'view', 'objectId' => $form->getId()]),
                        ],
                        ...
                        'contentTemplate' => 'AutobornaFormBundle:SubscribedEvents\Timeline:index.html.php',
