...
class FieldModel extends CommonFormModel
{
    ...
    public function createForm($entity, $formFactory, $action = null, $options = [])
    {
        ...
        $usedLeadFields   = $this->session->get('autoborna.form.'.$entity['formId'].'.fields.leadfields', []);
     ...
     * {@inheritdoc}
     *
     * @return \Autoborna\FormBundle\Entity\FieldRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('AutobornaFormBundle:Field');
    }
    ...
    {
        $fields = $this->session->get('autoborna.form.'.$formId.'.fields.modified', []);
        $remove = $this->session->get('autoborna.form.'.$formId.'.fields.deleted', []);
