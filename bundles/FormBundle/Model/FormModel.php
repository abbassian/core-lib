...
use Autoborna\LeadBundle\Helper\FormFieldHelper as ContactFieldHelper;
...
class FormModel extends CommonFormModel
{
     ...
     * {@inheritdoc}
     *
     * @return \Autoborna\FormBundle\Entity\FormRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('AutobornaFormBundle:Form');
    }
    ...
    public function deleteActions(Form $entity, $actions)
    {
        ...
        foreach ($actions as $actionId) {
            if (isset($existingActions[$actionId])) {
                $actionEntity = $this->em->getReference('AutobornaFormBundle:Action', (int) $actionId);
    ...
    public function generateHtml(Form $entity, $persist = true)
    {
        ...
        if ($entity->getRenderStyle()) {
            ...
            $styleTheme = $theme.'AutobornaFormBundle:Builder:style.html.php';
        ...
        $html               = $this->templatingHelper->getTemplating()->render(
            $theme.'AutobornaFormBundle:Builder:form.html.php',
            [
    ...
    public function getFormScript(Form $form)
    {
        ...
        $script = $this->templatingHelper->getTemplating()->render(
            $theme.'AutobornaFormBundle:Builder:script.html.php',
            [
                'form'  => $form,
                'theme' => $theme,
            ]
