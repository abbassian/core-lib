...
$header = ($activeForm->getId())
    ...
    $view['translator']->trans(
        'autoborna.form.form.header.edit',
        ['%name%' => $view['translator']->trans($activeForm->getName())]
    )
    :
    $view['translator']->trans('autoborna.form.form.header.new');
            ...
            <div class="col-xs-12">
                ...
                <div class="tab-content pa-md">
                    ...
                    <div class="tab-pane fade bdr-w-0" id="fields-container">
                        <?php echo $view->render('AutobornaFormBundle:Builder:style.html.php'); ?>
                        <div id="autobornaforms_fields">
                            <div class="row">
                                <div class="available-fields mb-md col-sm-4">
                                    <select class="chosen form-builder-new-component" data-placeholder="<?php echo $view['translator']->trans('autoborna.form.form.component.fields'); ?>">
                                        <option value=""></option>
                            ...
                            <?php if (!is_null($field['parent'])) {
                                ...
                                <?php if (!in_array($field['id'], $deletedFields)) : ?>
                                    <?php if (!empty($field['isCustom'])):
                                        ...
                                        $template = 'AutobornaFormBundle:Field:'.$field['type'].'.html.php';
                                    endif; ?>
                                    <?php
                            ...
                            <div class="alert alert-info" id="form-field-placeholder">
                                <p><?php echo $view['translator']->trans('autoborna.form.form.addfield'); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="tab-pane fade bdr-w-0" id="actions-container">
                        <div id="autobornaforms_actions">
                            <div class="row">
                                <div class="available-actions mb-md col-sm-4">
                                    <select class="chosen form-builder-new-component" data-placeholder="<?php echo $view['translator']->trans('autoborna.form.form.component.submitactions'); ?>">
                                        <option value=""></option>
                                            ...
                                            <?php
                                                ...
                                                foreach ($groupActions as $k => $e):
                                                    $actionOptions .= $view->render(
                                                        'AutobornaFormBundle:Action:option.html.php',
                                                        [
                                                            'action'       => $e,
                                                            'type'         => $k,
                            ...
                            <?php foreach ($formActions as $action): ?>
                                <?php if (!in_array($action['id'], $deletedActions)) : ?>
                                    <?php $template = (isset($actionSettings[$action['type']]['template']))
                                        ...
                                        :
                                        'AutobornaFormBundle:Action:generic.html.php';
                            ...
                            <div class="alert alert-info" id="form-action-placeholder">
                                <p><?php echo $view['translator']->trans('autoborna.form.form.addaction'); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
if (null === $activeForm->getFormType() || !empty($forceTypeSelection)):
    echo $view->render(
        'AutobornaCoreBundle:Helper:form_selecttype.html.php',
        [
            'item'       => $activeForm,
            'autobornaLang' => [
                'newStandaloneForm' => 'autoborna.form.type.standalone.header',
                'newCampaignForm'   => 'autoborna.form.type.campaign.header',
            ],
            'typePrefix'         => 'form',
            'cancelUrl'          => 'autoborna_form_index',
            'header'             => 'autoborna.form.type.header',
            'typeOneHeader'      => 'autoborna.form.type.campaign.header',
            'typeOneIconClass'   => 'fa-cubes',
            'typeOneDescription' => 'autoborna.form.type.campaign.description',
            'typeOneOnClick'     => "Autoborna.selectFormType('campaign');",
            'typeTwoHeader'      => 'autoborna.form.type.standalone.header',
            'typeTwoIconClass'   => 'fa-list',
            'typeTwoDescription' => 'autoborna.form.type.standalone.description',
            'typeTwoOnClick'     => "Autoborna.selectFormType('standalone');",
        ]
    );
endif;
