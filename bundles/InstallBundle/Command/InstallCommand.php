...
namespace Autoborna\InstallBundle\Command;
...
use Autoborna\InstallBundle\Configurator\Step\EmailStep;
...
/**
 * CLI Command to install Autoborna.
 * Class InstallCommand.
 */
class InstallCommand extends ContainerAwareCommand
{
    public const COMMAND = 'autoborna:install';
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Installs Autoborna')
            ...
            ->addOption(
                ...
                'From name for email sent from Autoborna.',
                null
            )
            ->addOption(
                '--mailer_from_email',
                null,
                InputOption::VALUE_OPTIONAL,
                'From email sent from Autoborna.',
                null
            )
            ->addOption(
                '--mailer_transport',
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \Autoborna\InstallBundle\Install\InstallService $installer */
        $installer = $container->get('autoborna.install.service');

        // Check Autoborna is not already installed
        if ($installer->checkIfInstalled()) {
            $output->writeln('Autoborna already installed');
