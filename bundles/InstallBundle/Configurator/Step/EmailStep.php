...
use Autoborna\InstallBundle\Configurator\Form\EmailStepType;
...
class EmailStep implements StepInterface
{
    ...
    {
        $user = $session->get('autoborna.installer.user');
        if (!empty($user)) {
    ...
    {
        return 'AutobornaInstallBundle:Install:email.html.php';
    }
