...
namespace Autoborna\InstallBundle\Tests\Install;
...
class InstallSchemaTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testBackupIndexesWithConfigOptions(): void
    {
        ...
        $autobornaTables = [$this->indexTableName => $this->dbParams['backup_prefix'].$this->indexTableName];

        $sql = $method->invokeArgs($schemaHelper, [$tables, $autobornaTables, $this->dbParams['backup_prefix']]);
