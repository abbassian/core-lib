...
class AuthenticationIntegrationPass implements CompilerPassInterface
{
    ...
    {
        $taggedServices     = $container->findTaggedServiceIds('autoborna.authentication_integration');
        $integrationsHelper = $container->findDefinition('autoborna.integrations.helper.auth_integrations');
