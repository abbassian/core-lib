...
use Autoborna\IntegrationsBundle\Integration\Interfaces\AuthenticationInterface;
...
class AuthIntegrationsHelper
{
    ...
    public function getIntegration(string $integration): AuthenticationInterface
    {
        if (!isset($this->integrations[$integration])) {
            throw new IntegrationNotFoundException("$integration either doesn't exist or has not been tagged with autoborna.authentication_integration");
        }
