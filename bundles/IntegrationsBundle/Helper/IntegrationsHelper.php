...
use Autoborna\IntegrationsBundle\Event\KeysDecryptionEvent;
use Autoborna\IntegrationsBundle\Event\KeysEncryptionEvent;
use Autoborna\IntegrationsBundle\Exception\IntegrationNotFoundException;
use Autoborna\IntegrationsBundle\Facade\EncryptionService;
...
class IntegrationsHelper
{
    ...
    public function getIntegration(string $integration)
    {
        if (!isset($this->integrations[$integration])) {
            throw new IntegrationNotFoundException("$integration either doesn't exist or has not been tagged with autoborna.basic_integration");
        }
