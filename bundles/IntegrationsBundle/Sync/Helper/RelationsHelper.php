...
use Autoborna\IntegrationsBundle\Sync\Exception\InternalIdNotFoundException;
...
class RelationsHelper
{
    ...
    /**
     * @throws \Autoborna\IntegrationsBundle\Sync\Exception\FieldNotFoundException
     * @throws \Autoborna\IntegrationsBundle\Sync\Exception\ObjectDeletedException
    ...
    private function findInternalObject(MappingManualDAO $mappingManualDao, string $relObjectName, ObjectDAO $objectDao): ObjectDAO
    {
        ...
        return $this->mappingHelper->findAutobornaObject($mappingManualDao, $internalObjectsName, $objectDao);
    }
