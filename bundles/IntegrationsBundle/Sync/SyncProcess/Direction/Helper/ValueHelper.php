...
namespace Autoborna\IntegrationsBundle\Sync\SyncProcess\Direction\Helper;
...
class ValueHelper
{
     ...
     * @throws InvalidValueException
     */
    public function getValueForAutoborna(NormalizedValueDAO $normalizedValueDAO, string $fieldState, string $syncDirection): NormalizedValueDAO
    {
        $this->normalizedValueDAO = $normalizedValueDAO;
        $this->fieldState         = $fieldState;
        $this->syncDirection      = $syncDirection;
