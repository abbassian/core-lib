...
namespace Autoborna\IntegrationsBundle\Tests\Unit\Command;

use Autoborna\IntegrationsBundle\Command\SyncCommand;
    ...
    public function testExecuteWithSomeOptions(): void
    {
        $this->syncService->expects($this->once())
            ...
            ->with($this->callback(function (InputOptionsDAO $inputOptionsDAO) {
                ...
                $this->assertSame(['123', '345'], $inputOptionsDAO->getAutobornaObjectIds()->getObjectIdsFor(Contact::NAME));
        ...
        $code = $this->commandTester->execute([
            ...
            '--disable-push'     => true,
            '--autoborna-object-id' => ['contact:123', 'contact:345'],
        ]);
