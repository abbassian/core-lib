...
namespace Autoborna\IntegrationsBundle\Tests\Unit\Sync\DAO\Mapping;
    ...
    public function testThatOneWayInternalObjectFieldsAreNotReturnedWhenNotRequired(): void
    {
        $this->assertEquals(
            [
                ...
                'firstname', // sync from autoborna to integration
            ],
    ...
    public function testThatOneWayIntegrationObjectFieldsAreNotReturnedWhenNotRequired(): void
    {
        $this->assertEquals(
            [
                'email',    // required and bidirectional
                'country',  // bidirectional
                'last_name', // sync from autoborna to integration
            ],
            $this->getMappingManualDAO()->getIntegrationObjectFieldsToSyncToAutoborna($this->integrationObjectName)
        );
    }
