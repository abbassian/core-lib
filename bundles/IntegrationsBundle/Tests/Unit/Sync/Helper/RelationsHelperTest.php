...
use Autoborna\IntegrationsBundle\Sync\DAO\Sync\RelationsDAO;
...
use Autoborna\IntegrationsBundle\Sync\DAO\Sync\Report\RelationDAO;
...
class RelationsHelperTest extends TestCase
{
    ...
    public function testProcessRelationsWithSychronisedObjects(): void
    {
        ...
        $internalObject = new ObjectDAO(AutobornaSyncDataExchange::OBJECT_COMPANY, $internalRelObjectId);
        ...
        $this->assertEquals(AutobornaSyncDataExchange::OBJECT_COMPANY, $objectDao->getField($relFieldName)->getValue()->getNormalizedValue()->getType());
    }
}
