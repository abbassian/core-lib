...
namespace Autoborna\IntegrationsBundle\Tests\Unit\Sync\SyncDataExchange\Internal\ObjectHelper;
...
use Autoborna\IntegrationsBundle\Sync\DAO\Value\ReferenceValueDAO;
...
class ContactObjectHelperTest extends TestCase
{
    ...
    public function testUpdate(): void
    {
        ...
        $companyValue->setType(AutobornaSyncDataExchange::OBJECT_COMPANY);
        ...
        $contact1->expects($this->exactly(2))
            ...
            ->withConsecutive(
                ['email', 'john@doe.com'],
                [AutobornaSyncDataExchange::OBJECT_COMPANY, 'Company A']
            );
    ...
    public function testDoNotContactIsAdded(): void
    {
        ...
        $objectChangeDAO->addField(new FieldDAO('autoborna_internal_dnc_email', new NormalizedValueDAO(NormalizedValueDAO::INT_TYPE, 1)));
    ...
    public function testDoNotContactIsRemoved(): void
    {
        ...
        $objectChangeDAO = new ObjectChangeDAO('Test', Contact::NAME, 1, 'MappedObject', 1, new \DateTime());
        $objectChangeDAO->addField(new FieldDAO('autoborna_internal_dnc_email', new NormalizedValueDAO(NormalizedValueDAO::INT_TYPE, 0)));
    ...
    public function testUnrecognizedDoNotContactDefaultsToManualDNC(): void
    {
        ...
        $objectChangeDAO = new ObjectChangeDAO('Test', Contact::NAME, 1, 'MappedObject', 1, new \DateTime());
        $objectChangeDAO->addField(new FieldDAO('autoborna_internal_dnc_email', new NormalizedValueDAO(NormalizedValueDAO::INT_TYPE, 4)));
