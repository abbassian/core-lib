...
class Lead extends FormEntity implements CustomFieldEntityInterface, IdentifierFieldEntityInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('leads')
            ->setCustomRepositoryClass('Autoborna\LeadBundle\Entity\LeadRepository')
        ...
        $builder->createManyToOne('owner', 'Autoborna\UserBundle\Entity\User')
            ->fetchLazy()
        ...
        $builder->createOneToMany('doNotContact', 'Autoborna\LeadBundle\Entity\DoNotContact')
            ->orphanRemoval()
            ->mappedBy('lead')
            ->cascadePersist()
            ->cascadeDetach()
        ...
        $builder->createManyToMany('ipAddresses', 'Autoborna\CoreBundle\Entity\IpAddress')
        ...
        $builder->createOneToMany('pushIds', 'Autoborna\NotificationBundle\Entity\PushID')
            ->orphanRemoval()
            ->mappedBy('lead')
            ->cascadeAll()
            ->fetchExtraLazy()
        ...
        $builder->createManyToMany('tags', 'Autoborna\LeadBundle\Entity\Tag')
        ...
        $builder->createOneToMany('utmtags', 'Autoborna\LeadBundle\Entity\UtmTag')
            ->orphanRemoval()
            ->mappedBy('lead')
            ->cascadeAll()
            ->fetchExtraLazy()
        ...
        $builder->createOneToMany('frequencyRules', 'Autoborna\LeadBundle\Entity\FrequencyRule')
            ->orphanRemoval()
            ->setIndexBy('channel')
            ->setOrderBy(['dateAdded' => 'DESC'])
            ->mappedBy('lead')
    ...
    public function getPrimaryIdentifier($lastFirst = false)
    {
        if ($name = $this->getName($lastFirst)) {
            ...
            return 'autoborna.lead.lead.anonymous';
        }
    }
     ...
     * Set stage.
     *
     * @param \Autoborna\StageBundle\Entity\Stage $stage
     *
     * @return Stage
     */
