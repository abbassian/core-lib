...
use Autoborna\LeadBundle\Form\Validator\Constraints\SegmentInUse;
use Autoborna\LeadBundle\Form\Validator\Constraints\UniqueUserAlias;
...
class LeadList extends FormEntity
{
    ...
    public static function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addConstraint(new UniqueUserAlias([
            'field'   => 'alias',
            'message' => 'autoborna.lead.list.alias.unique',
        ]));
