...
{
    use OperatorListTrait; // @deprecated to be removed in Autoborna 3. Not used inside this class.
    ...
    protected function addSearchCommandWhereClause($q, $filter)
    {
        ...
        switch ($command) {
            case $this->translator->trans('autoborna.lead.list.searchcommand.isglobal'):
            case $this->translator->trans('autoborna.lead.list.searchcommand.isglobal', [], null, 'en_US'):
    ...
    {
        $commands = [
            'autoborna.lead.list.searchcommand.isglobal',
