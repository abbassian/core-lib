...
trait OperatorListTrait
{
    ...
    /**
     * @deprecated to be removed in Autoborna 3. Use FilterOperatorProvider::getAllOperators() instead.
     *
    ...
    /**
     * @deprecated These aliases are subscribed in the TypeOperatorSubscriber now so this is not necessary. To be removed in next Autoborna version.
     *
