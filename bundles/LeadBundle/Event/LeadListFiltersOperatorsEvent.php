...
class LeadListFiltersOperatorsEvent extends CommonEvent
{
    ...
    /**
     * @deprecated to be removed in Autoborna 3
     *
     ...
     * @deprecated to be removed in Autoborna 3
     *
     * @param array               $operators  @deprecated to be removed in Autoborna 3. Subscribe operators instead.
     * @param TranslatorInterface $translator @deprecated to be removed in Autoborna 3
     */
    ...
    /**
     * @deprecated to be removed in Autoborna 3. Use DI instead.
     *
