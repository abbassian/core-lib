...
class CalendarSubscriber implements EventSubscriberInterface
{
    ...
    public function onCalendarGenerate(CalendarGeneratorEvent $event)
    {
        ...
        foreach ($results as &$object) {
            ...
            $object['url']         = $this->router->generate('autoborna_contact_action', ['objectAction' => 'view', 'objectId' => $object['lead_id']], true);
            ...
            //$object['title'] .= ' (' . $this->translator->trans('autoborna.lead.note.type.' . $object['type']) . ')';
        }
