...
class ReportDNCSubscriber implements EventSubscriberInterface
{
    ...
    public function onReportBuilder(ReportBuilderEvent $event)
    {
        ...
        $dncColumns = [
            'dnc.reason' => [
                'label' => 'autoborna.lead.report.dnc_reason',
                'type'  => 'select',
                'list'  => $this->getDncReasons(),
            ],
            'dnc.comments' => [
                'label' => 'autoborna.lead.report.dnc_comment',
                'type'  => 'text',
            ],
            'dnc.date_added' => [
                'label' => 'autoborna.lead.report.dnc_date_added',
                'type'  => 'datetime',
            ],
            'dnc.channel' => [
                'label' => 'autoborna.lead.report.dnc_channel',
                'type'  => 'html',
            ],
            'dnc.channel_id' => [
                'label' => 'autoborna.lead.report.dnc_channel_id',
                'type'  => 'html',
            ],
        ];

        $data = [
            'display_name' => 'autoborna.lead.report.dnc',
    ...
    {
        return [
            0 => $this->translator->trans('autoborna.lead.report.dnc_contactable'),
            1 => $this->translator->trans('autoborna.lead.report.dnc_unsubscribed'),
            2 => $this->translator->trans('autoborna.lead.report.dnc_bounced'),
            3 => $this->translator->trans('autoborna.lead.report.dnc_manual'),
        ];
    }
