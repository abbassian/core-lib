...
class CampaignEventLeadFieldValueType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add(
            ...
            [
                'label'                 => 'autoborna.lead.campaign.event.field',
                ...
                'attr'                  => [
                    'class'    => 'form-control',
                    'tooltip'  => 'autoborna.lead.campaign.event.field_descr',
                    'onchange' => 'Autoborna.updateLeadFieldValues(this)',
                ],
                'required'    => true,
                'constraints' => [
                    new NotBlank(
                        ...
                        switch ($fieldType) {
                            ...
                            case 'datetime':
                                if ('date' === $operator) {
                                    ...
                                    $customText  = $this->translator->trans('autoborna.campaign.event.timed.choice.custom');
            ...
            if (!empty($fieldValues) && $supportsChoices) {
                $form->add(
                    ...
                    [
                        ...
                        'label'             => 'autoborna.form.field.form.value',
                        'label_attr'        => ['class' => 'control-label'],
                        'attr'              => [
                            'class'                => 'form-control',
                            'onchange'             => 'Autoborna.updateLeadFieldValueOptions(this)',
