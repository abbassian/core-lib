...
class ConfigType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            NumberType::class,
            [
                'label'      => 'autoborna.lead.background.import.if.more.rows.than',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.lead.background.import.if.more.rows.than.tooltip',
                ],
            ]
        );
        ...
        $formModifier = function (FormInterface $form, $currentColumns) {
            ...
            $form->add(
                ...
                [
                    'label'       => 'autoborna.config.tab.columns',
                    'label_attr'  => ['class' => 'control-label'],
                    'attr'        => [
