    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            [
                ...
                'attr'              => ['onClick' => 'Autoborna.togglePreferredChannel(this.value);'],
                'multiple'          => true,
                'label'             => false,
                'required'          => false,
            ]
        ...
        if (!$options['public_view'] || $showContactPreferredChannels) {
            $builder->add(
                ...
                [
                    ...
                    'expanded'          => false,
                    'multiple'          => false,
                    'label'             => 'autoborna.lead.list.frequency.preferred.channel',
                    'label_attr'        => ['class' => 'control-label'],
                    'placeholder'       => false,
                    'required'          => false,
                    'attr'              => [
                        'class'   => 'form-control',
                        'tooltip' => 'autoborna.lead.list.frequency.preferred.channel',
                    ],
                ]
            );
        }
        ...
        if (!$options['public_view'] || $showContactFrequency || $showContactPauseDates) {
            foreach ($options['channels'] as $channel) {
                ...
                $builder->add(
                    ...
                    [
                        'choices'           => [
                            'autoborna.core.time.days'   => FrequencyRule::TIME_DAY,
                            'autoborna.core.time.weeks'  => FrequencyRule::TIME_WEEK,
                            'autoborna.core.time.months' => FrequencyRule::TIME_MONTH,
                        ],
                ...
                if (!$options['public_view'] || $showContactPauseDates) {
                    ...
                    $builder->add(
                        ...
                        $this->configureDateTypeOptions([
                            'widget'     => 'single_text',
                            'label'      => 'autoborna.lead.frequency.contact.end.date',
