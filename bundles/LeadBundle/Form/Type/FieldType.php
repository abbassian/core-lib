...
use Autoborna\LeadBundle\Field\IdentifierFields;
use Autoborna\LeadBundle\Form\DataTransformer\FieldToOrderTransformer;
...
class FieldType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            [
                'choices' => [
                    'autoborna.lead.field.group.core'         => 'core',
                    'autoborna.lead.field.group.social'       => 'social',
                    'autoborna.lead.field.group.personal'     => 'personal',
                    'autoborna.lead.field.group.professional' => 'professional',
                ],
                'attr' => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.lead.field.form.group.help',
                ],
                'expanded'    => false,
                'multiple'    => false,
                'label'       => 'autoborna.lead.field.group',
                'placeholder' => false,
                'required'    => false,
                'disabled'    => $disabled,
            ]
        ...
        $builder->add(
            ...
            [
                ...
                'expanded'    => false,
                'multiple'    => false,
                'label'       => 'autoborna.lead.field.type',
                'placeholder' => false,
                'disabled'    => ($disabled || !$new),
                'attr'        => [
                    'class'    => 'form-control',
                    'onchange' => 'Autoborna.updateLeadFieldProperties(this.value);',
                ],
                'data'     => $default,
                'required' => false,
            ]
        ...
        $builder->add(
            ...
            [
                'mapped'          => false,
                'label'           => 'autoborna.lead.field.form.properties.select',
        ...
        $builder->add(
            ...
            [
                'label'       => 'autoborna.lead.field.form.properties.allowhtml',
                'label_attr'  => ['class' => 'control-label'],
        ...
        $builder->add(
            ...
            [
                ...
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.lead.field.help.defaultvalue',
                ],
                'required'   => false,
            ...
            switch ($type) {
                ...
                case 'boolean':
                    if (is_array($data)) {
                        ...
                        $yesLabel = !empty($data['properties']['yes']) ? $data['properties']['yes'] : 'autoborna.core.form.yes';
                        $noLabel  = !empty($data['properties']['no']) ? $data['properties']['no'] : 'autoborna.core.form.no';
                    } else {
                        $value    = $data->getDefaultValue();
                        $props    = $data->getProperties();
                        $yesLabel = !empty($props['yes']) ? $props['yes'] : 'autoborna.core.form.yes';
                        $noLabel  = !empty($props['no']) ? $props['no'] : 'autoborna.core.form.no';
                    }
                                ...
                                new Assert\Callback(
                                    function ($object, ExecutionContextInterface $context) {
                                        if (!empty($object) && false === \DateTime::createFromFormat('Y-m-d H:i', $object)) {
                                            $context->buildViolation('autoborna.lead.datetime.invalid')->addViolation();
                                        }
                                    }
                                ),
                            ];
                                    ...
                                    function ($object, ExecutionContextInterface $context) {
                                        if (!empty($object)) {
                                            ...
                                            if (count($violations) > 0) {
                                                $context->buildViolation('autoborna.lead.date.invalid')->addViolation();
                                            }
                                        }
                                    }
                                ),
                                ...
                                new Assert\Callback(
                                    function ($object, ExecutionContextInterface $context) {
                                        if (!empty($object)) {
                                            ...
                                            if (count($violations) > 0) {
                                                $context->buildViolation('autoborna.lead.time.invalid')->addViolation();
                                            }
                                        }
                                    }
                                ),
        ...
        $builder->add(
            $builder->create(
                ...
                EntityType::class,
                [
                    'label'         => 'autoborna.core.order',
                    'class'         => 'AutobornaLeadBundle:LeadField',
                    'choice_label'  => 'label',
                    'label_attr'    => ['class' => 'control-label'],
                    'attr'          => ['class' => 'form-control'],
        ...
        $builder->add(
            ...
            [
                ...
                'attr'       => [
                    'class'   => 'form-control',
                    'length'  => 25,
                    'tooltip' => 'autoborna.lead.field.help.alias',
                ],
                'required'   => false,
                'disabled'   => ($disabled || !$new),
            ]
        ...
        if ($options['data']->getColumnIsNotCreated()) {
            $attr = [
                'tooltip' => 'autoborna.lead.field.being_created_in_background',
            ];
        }
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'autoborna.lead.field.form.isvisible',
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'autoborna.lead.field.form.isshortvisible',
                'attr'  => [
                    'tooltip' => 'autoborna.lead.field.form.isshortvisible.tooltip',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'autoborna.lead.field.form.islistable',
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'autoborna.lead.field.form.isuniqueidentifer',
                'attr'  => [
                    'tooltip'  => 'autoborna.lead.field.form.isuniqueidentifer.tooltip',
                    'onchange' => 'Autoborna.displayUniqueIdentifierWarning(this)',
                ],
                'data' => (!empty($data)),
            ]
        );
        ...
        $builder->add(
            ...
            YesNoButtonGroupType::class,
            [
                'label' => 'autoborna.lead.field.form.ispubliclyupdatable',
                'attr'  => [
                    'tooltip' => 'autoborna.lead.field.form.ispubliclyupdatable.tooltip',
                ],
            ]
        );
        ...
        $builder->add(
            ...
            [
                'choices' => [
                    'autoborna.lead.contact'    => 'lead',
                    'autoborna.company.company' => 'company',
                ],
                'expanded'    => false,
                'multiple'    => false,
                'label'       => 'autoborna.lead.field.object',
                'placeholder' => false,
                'attr'        => ['class' => 'form-control'],
                'required'    => false,
                'disabled'    => ($disabled || !$new),
