...
use Autoborna\LeadBundle\Entity\RegexTrait;
        ...
        switch ($fieldType) {
            ...
            case 'tags':
                ...
                $attr                                       = array_merge(
                    $attr,
                    [
                        'data-placeholder'     => $translator->trans('autoborna.lead.tags.select_or_create'),
                        'data-no-results-text' => $translator->trans('autoborna.lead.tags.enter_to_create'),
                        'data-allow-add'       => 'true',
                ...
                $displayAttr = array_merge(
                    ...
                    [
                        ...
                        'placeholder'          => $translator->trans(
                            'autoborna.lead.list.form.filtervalue'
                        ),
                    ]
                );
            ...
            case 'boolean':
                $attr = array_merge(
                    $attr,
                    [
                        'placeholder' => $translator->trans('autoborna.lead.list.form.filtervalue'),
                    ]
                );
                    ...
                    new Callback(
                        function ($regex, ExecutionContextInterface $context) {
                            ...
                            try {
                                ...
                                $context->buildViolation('autoborna.core.regex.invalid')->addViolation();
                            }
                        }
                    );
            }
        ...
        $form->add(
            ...
            [
                ...
                'attr'    => [
                    ...
                    'onchange' => 'Autoborna.convertDwcFilterInput(this)',
                ],
            ]
        );
