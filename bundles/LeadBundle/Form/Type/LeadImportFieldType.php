...
class LeadImportFieldType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ('lead' === $options['object']) {
            $builder->add(
                $builder->create(
                    ...
                    LeadListType::class,
                    [
                        'label'      => 'autoborna.lead.lead.field.list',
                        'label_attr' => ['class' => 'control-label'],
                        'attr'       => [
                            'class' => 'form-control',
                        ],
        ...
        $builder->add(
            ...
            [
                'label'       => 'autoborna.lead.import.skip_if_exists',
                'label_attr'  => ['class' => 'control-label'],
                'attr'        => ['class' => 'form-control'],
                'required'    => false,
                'data'        => false,
        ...
        if (empty($options['line_count_limit'])) {
            $buttons = array_merge(
                $buttons,
                [
                    'apply_text'  => 'autoborna.lead.import.in.background',
                    'apply_class' => 'btn btn-success',
                    'apply_icon'  => 'fa fa-history',
                    'save_text'   => 'autoborna.lead.import.start',
            ...
            $buttons = array_merge(
                ...
                [
                    'apply_text' => false,
                    'save_text'  => 'autoborna.lead.import',
                    'save_class' => 'btn btn-primary',
                    'save_icon'  => 'fa fa-upload',
                ]
            );
