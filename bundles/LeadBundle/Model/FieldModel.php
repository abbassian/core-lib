...
use Autoborna\LeadBundle\Field\SchemaDefinition;
use Autoborna\LeadBundle\Form\Type\FieldType;
    ...
    public function getFieldListWithProperties($object = 'lead')
    {
        ...
        foreach ($contactFields as $contactField) {
            $fields[$contactField['alias']] = [
                ...
                'group_label'  => $this->translator->trans('autoborna.lead.field.group.'.$contactField['group']),
