...
namespace Autoborna\LeadBundle\Segment\Query;
...
use Autoborna\LeadBundle\Event\LeadListFilteringEvent;
use Autoborna\LeadBundle\Event\LeadListQueryBuilderGeneratedEvent;
use Autoborna\LeadBundle\LeadEvents;
use Autoborna\LeadBundle\Segment\ContactSegmentFilter;
use Autoborna\LeadBundle\Segment\ContactSegmentFilters;
use Autoborna\LeadBundle\Segment\Exception\PluginHandledFilterException;
...
class ContactSegmentQueryBuilder
{
    ...
    {
        $segment = $this->entityManager->getRepository('AutobornaLeadBundle:LeadList')->find($segmentId);
        if (null === $segment) {
            return [];
        }
