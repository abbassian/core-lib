...
use Autoborna\LeadBundle\Segment\ContactSegmentFilterFactory;
...
use Autoborna\LeadBundle\Segment\Query\ContactSegmentQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Expression\CompositeExpression;
...
class SegmentReferenceFilterQueryBuilder extends BaseFilterQueryBuilder
{
    ...
    {
        return 'autoborna.lead.query.builder.special.leadlist';
    }
    ...
    public function applyQuery(QueryBuilder $queryBuilder, ContactSegmentFilter $filter)
    {
        ...
        foreach ($segmentIds as $segmentId) {
            ...
            $contactSegment = $this->entityManager->getRepository('AutobornaLeadBundle:LeadList')->find($segmentId);
            if (!$contactSegment) {
