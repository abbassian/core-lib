...
use Autoborna\LeadBundle\Segment\Query\Filter\BaseFilterQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Filter\ChannelClickQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Filter\DoNotContactFilterQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Filter\ForeignFuncFilterQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Filter\ForeignValueFilterQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Filter\IntegrationCampaignFilterQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Filter\SegmentReferenceFilterQueryBuilder;
use Autoborna\LeadBundle\Segment\Query\Filter\SessionsFilterQueryBuilder;
