...
namespace Autoborna\LeadBundle\Tests\Command;

use Autoborna\CoreBundle\Test\AutobornaMysqlTestCase;
use Autoborna\LeadBundle\Command\UpdateLeadListsCommand;
use Autoborna\LeadBundle\Entity\Lead;
use Autoborna\LeadBundle\Entity\LeadList;
use Autoborna\LeadBundle\Entity\LeadListRepository;
use PHPUnit\Framework\Assert;

final class UpdateLeadListCommandFunctionalTest extends AutobornaMysqlTestCase
{
    /**
