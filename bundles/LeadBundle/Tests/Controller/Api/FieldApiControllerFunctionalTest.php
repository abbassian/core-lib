...
namespace Autoborna\LeadBundle\Tests\Controller\Api;

use Doctrine\Common\Annotations\Annotation\IgnoreAnnotation;
use Autoborna\CoreBundle\Test\AutobornaMysqlTestCase;
use Autoborna\LeadBundle\Field\Command\CreateCustomFieldCommand;
 ...
 */
final class FieldApiControllerFunctionalTest extends AutobornaMysqlTestCase
{
    ...
    /**
     * @covers \Autoborna\LeadBundle\Controller\Api\FieldApiController::saveEntity
     * @covers \Autoborna\LeadBundle\Controller\Api\FieldApiController::newEntityAction
     * @covers \Autoborna\LeadBundle\Controller\Api\FieldApiController::editEntityAction
     * @covers \Autoborna\LeadBundle\Controller\Api\FieldApiController::deleteEntityAction
     * @covers \Autoborna\LeadBundle\Field\Command\CreateCustomFieldCommand::execute
     */
    ...
    private function executeCommand(int $id): void
    {
        ...
        $command    = $this->client->getKernel()->getContainer()->get('autoborna.lead.command.create_custom_field');
