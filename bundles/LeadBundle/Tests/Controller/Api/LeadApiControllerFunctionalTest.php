...
class LeadApiControllerFunctionalTest extends AutobornaMysqlTestCase
{
    public function testBatchNewEndpointDoesNotCreateDuplicates(): void
    {
        ...
        // Set first name as null - Autoborna should keep the value
    ...
    {
        // Create contact
        $emailAddress = uniqid('', false).'@autoborna.com';
    ...
    public function testAddAndRemoveDncToExistingContact(): void
    {
        // Create contact
        $payload = [
            'email' => 'addDncDemo@autoborna.org',
        ];
        ...
        // MANUAL (3) is the default value according to the dev docs: https://developer.autoborna.org/#add-do-not-contact
