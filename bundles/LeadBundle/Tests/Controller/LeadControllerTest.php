...
use Autoborna\LeadBundle\DataFixtures\ORM\LoadCategorizedLeadListData;
use Autoborna\LeadBundle\DataFixtures\ORM\LoadCategoryData;
...
class LeadControllerTest extends AutobornaMysqlTestCase
{
    /**
     ...
     * We do more in-depth tests in \Autoborna\CoreBundle\Tests\Unit\Helper\ExportHelperTest.
     */
    ...
    public function testEnsureCorrectPreferredTimeZonePlaceHolderOnContactPage(): void
    {
        ...
        $expectedPlaceholder = self::$container->get('translator')->trans('autoborna.lead.field.timezone');
    ...
    public function testAddContactsErrorMessage(): void
    {
        ...
        $fieldModel     = self::getContainer()->get('autoborna.lead.model.field');
    ...
    public function testContactCompanyEditShowsOldCompanyNameInAuditLog(): void
    {
        ...
        $contactModel = self::$container->get('autoborna.lead.model.lead');
