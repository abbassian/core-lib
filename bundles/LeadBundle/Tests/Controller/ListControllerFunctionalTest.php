...
class ListControllerFunctionalTest extends AutobornaMysqlTestCase
{
    /**
     * @var ListModel
     */
    ...
    {
        parent::setUp();
        $this->listModel = self::$container->get('autoborna.lead.model.list');
        ...
        $leadModel = self::$container->get('autoborna.lead.model.lead');
    ...
    public function testSegmentCount(): void
    {
        ...
        $this->runCommand('autoborna:segments:update', ['-i' => $segmentId, '--env' => 'test']);
