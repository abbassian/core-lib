...
use Autoborna\LeadBundle\Entity\CustomFieldRepositoryTrait;
use Autoborna\LeadBundle\Tests\StandardImportTestHelper;
...
class CustomFieldRepositoryTraitTest extends StandardImportTestHelper
{
    ...
    public function testFormatFieldValues()
    {
        ...
        $mockTrait->method('getClassName')
            ->will($this->returnValue('Autoborna\LeadBundle\Entity\Lead'));
