...
class FrequencyRuleRepositoryTest extends AutobornaMysqlTestCase
{
    /**
    ...
    {
        parent::setUp();
        $this->frequencyRuleRepository = self::$container->get('autoborna.lead.repository.frequency_rule');
    }
