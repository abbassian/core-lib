...
class LeadRepositoryFunctionalTest extends AutobornaMysqlTestCase
{
    /**
     * @var Lead
     */
    ...
    {
        $model = self::$container->get('autoborna.lead.model.lead');
    ...
    public function testMixedModelAndRepositorySavesDoNotDoublePoints()
    {
        ...
        $model->saveEntity($this->lead);
        $this->em->getRepository('AutobornaLeadBundle:Lead')->saveEntity($this->lead);
