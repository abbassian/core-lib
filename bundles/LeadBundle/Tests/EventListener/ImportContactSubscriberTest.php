...
use Autoborna\LeadBundle\EventListener\ImportContactSubscriber;
...
final class ImportContactSubscriberTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @see https://github.com/autoborna/autoborna/issues/11080
     */
    ...
    public function testOnImportInitForContactsObjectWithPermissions(): void
    {
        ...
        Assert::assertSame('autoborna.lead.leads', $event->objectName);
        Assert::assertSame('#autoborna_contact_index', $event->activeLink);
        Assert::assertSame('autoborna_contact_index', $event->indexRoute);
    }
    ...
    public function testOnFieldMapping(): void
    {
        ...
        Assert::assertSame(
            [
                'autoborna.lead.contact' => [
                    'id' => 'autoborna.lead.import.label.id',
                    'some fields',
                ],
