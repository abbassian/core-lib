...
use Autoborna\LeadBundle\EventListener\OwnerSubscriber;
...
class OwnerSubscriberTest extends \PHPUnit\Framework\TestCase
{
     ...
     *
     * @return AutobornaFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    protected function getMockFactory($mailIsOwner = true, $parameterMap = [])
    {
        ...
        /** @var AutobornaFactory|\PHPUnit_Framework_MockObject_MockObject $mockFactory */
    ...
    protected function getMockMailer(array $lead)
    {
        ...
        /** @var AutobornaFactory $mockFactory */
