...
use Autoborna\LeadBundle\Event\FormAdjustmentEvent;
use Autoborna\LeadBundle\Event\ListFieldChoicesEvent;
use Autoborna\LeadBundle\Event\TypeOperatorsEvent;
use Autoborna\LeadBundle\EventListener\TypeOperatorSubscriber;
        ...
        $this->form->expects($this->once())
            ...
            ->with(
                ...
                [
                    ...
                    'attr'                      => [
                        'class'                => 'form-control',
                        'data-placeholder'     => 'autoborna.lead.tags.select_or_create',
                        'data-no-results-text' => 'autoborna.lead.tags.enter_to_create',
                        'data-allow-add'       => true,
                        ...
                        function (array $options) {
                            ...
                            $this->assertSame(
                                [
                                    ...
                                    'data-target'           => 'owner',
                                    'placeholder'           => 'autoborna.lead.list.form.startTyping',
                                    'data-no-record-message'=> 'autoborna.core.form.nomatches',
                                ],
                                $options['attr']
                            );
            ...
            ->with(
                ...
                [
                    ...
                    'attr'     => [
                        ...
                        'placeholder'  => 'autoborna.lead.list.form.filtervalue',
                    ],
                ]
            );
