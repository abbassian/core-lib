...
namespace Autoborna\LeadBundle\Tests\Form\Type;

use Autoborna\LeadBundle\Form\Type\LeadFieldsType;
                    ...
                    $this->assertSame(
                        [
                            'Core' => [
                              ...
                              'autoborna.lead.field.tags' => 'tags',
                            ],
                            'Company' => [
                              'Company field 1 label' => 'company_field_1',
                            ],
                            'UTM' => [
                              'autoborna.lead.field.utmcampaign' => 'utm_campaign',
                              'autoborna.lead.field.utmcontent'  => 'utm_content',
                              'autoborna.lead.field.utmmedium'   => 'utm_medium',
                              'autoborna.lead.field.umtsource'   => 'utm_source',
                              'autoborna.lead.field.utmterm'     => 'utm_term',
                            ],
                        ],
                        $choices
                    );
