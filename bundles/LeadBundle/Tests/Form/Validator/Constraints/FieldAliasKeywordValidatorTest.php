...
namespace Autoborna\LeadBundle\Tests\Form\Validator\Constraints;

use Doctrine\ORM\EntityManager;
use Doctrine\ORM\UnitOfWork;
use Autoborna\LeadBundle\Entity\LeadField;
use Autoborna\LeadBundle\Form\Validator\Constraints\FieldAliasKeyword;
use Autoborna\LeadBundle\Form\Validator\Constraints\FieldAliasKeywordValidator;
use Autoborna\LeadBundle\Helper\FieldAliasHelper;
...
class FieldAliasKeywordValidatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddValidationFailure()
    {
        ...
        $this->executionContextMock->expects($this->once())->method('addViolation')->with('autoborna.lead.field.keyword.invalid');
