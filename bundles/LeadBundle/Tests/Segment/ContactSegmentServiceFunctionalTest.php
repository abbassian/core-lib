...
namespace Autoborna\LeadBundle\Tests\Segment;

use Doctrine\Common\DataFixtures\ReferenceRepository;
use Autoborna\CoreBundle\Test\AutobornaMysqlTestCase;
use Autoborna\LeadBundle\DataFixtures\ORM\LoadCompanyData;
use Autoborna\LeadBundle\DataFixtures\ORM\LoadLeadData;
use Autoborna\LeadBundle\DataFixtures\ORM\LoadLeadFieldData;
use Autoborna\LeadBundle\DataFixtures\ORM\LoadLeadListData;
use Autoborna\LeadBundle\Entity\LeadList;
use Autoborna\LeadBundle\Segment\ContactSegmentService;
use Autoborna\LeadBundle\Tests\DataFixtures\ORM\LoadClickData;
use Autoborna\LeadBundle\Tests\DataFixtures\ORM\LoadDncData;
use Autoborna\LeadBundle\Tests\DataFixtures\ORM\LoadPageHitData;
use Autoborna\LeadBundle\Tests\DataFixtures\ORM\LoadSegmentsData;
use Autoborna\LeadBundle\Tests\DataFixtures\ORM\LoadTagData;
use Autoborna\PageBundle\DataFixtures\ORM\LoadPageCategoryData;
use Autoborna\UserBundle\DataFixtures\ORM\LoadRoleData;
use Autoborna\UserBundle\DataFixtures\ORM\LoadUserData;
use PHPUnit\Framework\Assert;

/**
 * These tests cover same tests like \Autoborna\LeadBundle\Tests\Model\ListModelFunctionalTest.
 */
class ContactSegmentServiceFunctionalTest extends AutobornaMysqlTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->contactSegmentService = self::$container->get('autoborna.lead.model.lead_segment_service');
    }
    ...
    public function testSegmentRebuildCommand(): void
    {
        ...
        $this->runCommand('autoborna:segments:update', [
