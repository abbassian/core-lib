...
namespace Autoborna\LeadBundle\Tests\Tracker;
...
use Autoborna\LeadBundle\Tracker\Factory\DeviceDetectorFactory\DeviceDetectorFactory;
use Autoborna\LeadBundle\Tracker\Service\DeviceCreatorService\DeviceCreatorService;
...
class DeviceTrackerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $coreParametersHelper->expects($this->once())
          ...
          ->willReturn('autoborna.cache.adapter.filesystem');

        $container = $this->createMock(ContainerInterface::class);
        $container
          ->expects($this->once())
          ->method('has')
          ->with($this->equalTo('autoborna.cache.adapter.filesystem'))
          ->willReturn(true);
        $container
          ->expects($this->once())
          ->method('get')
