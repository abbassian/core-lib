...
namespace Autoborna\LeadBundle\Tests\Tracker\Service\ContactTrackingService;
...
use Autoborna\LeadBundle\Entity\MergeRecordRepository;
use Autoborna\LeadBundle\Tracker\Service\ContactTrackingService\ContactTrackingService;
...
final class ContactTrackingServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetTrackedIdentifier(): void
    {
        ...
        $this->cookieHelperMock->expects($this->once())
            ->method('getCookie')
            ->with('autoborna_session_id', null)
