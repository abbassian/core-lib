...
namespace Autoborna\LeadBundle\Tests\Tracker\Service\DeviceTrackingService;
...
use Autoborna\LeadBundle\Tracker\Service\DeviceTrackingService\DeviceTrackingService;
...
final class DeviceTrackingServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTrackCurrentDeviceAlreadyTrackedReplaceExistingTracking(): void
    {
        ...
        $this->cookieHelperMock->method('setCookie')
            ->withConsecutive(['autoborna_device_id', $uniqueTrackingIdentifier, 31536000]);
