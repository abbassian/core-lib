...
use Autoborna\LeadBundle\Model\DefaultValueTrait;
use Autoborna\LeadBundle\Model\FieldModel;
use Autoborna\LeadBundle\Tracker\Service\ContactTrackingService\ContactTrackingServiceInterface;
use Monolog\Logger;
...
class ContactTracker
{
    ...
    private function getSystemContact()
    {
        ...
        if ($this->isUserSession()) {
            $this->logger->addDebug('CONTACT: In a Autoborna user session');
        }
