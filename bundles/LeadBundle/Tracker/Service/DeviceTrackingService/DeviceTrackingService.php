...
final class DeviceTrackingService implements DeviceTrackingServiceInterface
{
    ...
    {
        $this->cookieHelper->deleteCookie('autoborna_device_id');
    ...
    private function getTrackedIdentifier(): ?string
    {
        ...
        $deviceTrackingId = $this->cookieHelper->getCookie('autoborna_device_id', null);
        if (null === $deviceTrackingId) {
            $deviceTrackingId = $request->get('autoborna_device_id', null);
        }
    ...
    {
        // Device cookie
        $this->cookieHelper->setCookie('autoborna_device_id', $device->getTrackingId(), 31536000);
