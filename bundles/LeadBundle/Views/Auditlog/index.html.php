...
<!-- filter form -->
<form method="post" action="<?php echo $view['router']->path('autoborna_contact_auditlog_action', ['leadId' => $lead->getId()]); ?>" class="panel" id="auditlog-filters">
    ...
    <?php if (isset($events['types']) && is_array($events['types'])) : ?>
        <div class="history-search panel-footer text-muted">
            ...
            <div class="col-sm-2">
                <a class="btn btn-default btn-block" href="<?php echo $view['router']->url('autoborna_contact_auditlog_export_action', ['leadId' => $lead->getId()]); ?>" data-toggle="download">
                    <span>
