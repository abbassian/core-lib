...
if (isset($tmpl) && 'index' == $tmpl) {
    $view->extend('AutobornaLeadBundle:Auditlog:index.html.php');
}
    ...
    <table class="table table-hover table-bordered" id="contact-auditlog">
        ...
        <tr>
            ...
            echo $view->render('AutobornaCoreBundle:Helper:tableheader.html.php', [
                'orderBy'    => 'userName',
                'text'       => 'autoborna.lead.timeline.user_name',
                'class'      => 'timeline-name',
        ...
        <?php foreach ($events['events'] as $counter => $event): ?>
            ...
            <tr class="timeline-row<?php echo $rowStripe; ?><?php if (!empty($event['featured'])) {
                ...
                echo $view['translator']->trans('autoborna.lead.event.'.$event['eventType']);
            } ?></td>
