            ...
            echo ' in active';
                ...
                <?php if (empty($embedded)): ?>
                    <div class="pa-md bg-auto bg-light-xs bdr-b">
                        <h4 class="fw-sb">
                            <?php echo $view['translator']->trans('autoborna.lead.field.group.'.$group); ?>
                        </h4>
                    </div>
                <?php endif; ?>
                <div class="pa-md">
                    <?php if ('core' == $group): ?>
                        ...
                        <?php if (isset($form['companyaddress1']) || isset($form['companyaddress2']) || isset($form['companycity'])
                            ...
                            <div class="form-group mb-0">
                                <label
                                    class="control-label mb-xs"><?php echo $view['translator']->trans('autoborna.company.field.address'); ?></label>
