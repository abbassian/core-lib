...
<table class="table table-bordered table-striped mb-0">
    <thead>
        <tr>
            ...
            <th><?php echo $view['translator']->trans('autoborna.lead.device.header'); ?></th>
            <th><?php echo $view['translator']->trans('autoborna.lead.device_os_name.header'); ?></th>
            <th><?php echo $view['translator']->trans('autoborna.lead.device_os_version.header'); ?></th>
            <th><?php echo $view['translator']->trans('autoborna.lead.device_browser.header'); ?></th>
            <th><?php echo $view['translator']->trans('autoborna.lead.device_brand.header'); ?></th>
            <th><?php echo $view['translator']->trans('autoborna.core.date.added'); ?></th>
        </tr>
    </thead>
    <tbody>
    <?php foreach ($devices as $device): ?>
        <tr>
            ...
            <td><?php echo $view['translator']->transConditional('autoborna.lead.device.'.$device['device'], ucfirst($device['device'])); ?></td>
