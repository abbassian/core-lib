    ...
    $buttons[] = [
        'attr' => [
            ...
            'data-header' => $view['translator']->trans(
                'autoborna.lead.email.send_email.header',
        ...
        'btnText'   => $view['translator']->trans('autoborna.lead.email.send_email'),
...
if ($edit) {
    $buttons[] = [
        'attr' => [
            ...
            'data-target' => '#AutobornaSharedModal',
            'data-header' => $view['translator']->trans(
                'autoborna.lead.lead.header.contact.frequency',
        ...
        'btnText'   => $view['translator']->trans('autoborna.lead.contact.frequency'),
...
if ($view['security']->isGranted('campaign:campaigns:edit')) {
    $buttons[] = [
        'attr' => [
            ...
            'data-target' => '#AutobornaSharedModal',
            'data-header' => $view['translator']->trans(
                'autoborna.lead.lead.header.campaigns',
                ['%name%' => $view->escape($lead->getPrimaryIdentifier())]
            ),
            'data-footer' => 'false',
            'href'        => $view['router']->path(
        ...
        'btnText'   => $view['translator']->trans('autoborna.campaign.campaigns'),
...
if (($view['security']->hasEntityAccess(
    ...
    $buttons[] = [
        'attr' => [
            ...
            'data-target' => '#AutobornaSharedModal',
            'data-header' => $view['translator']->trans(
                'autoborna.lead.lead.header.merge',
                ['%name%' => $view->escape($lead->getPrimaryIdentifier())]
            ),
            'href' => $view['router']->path(
                'autoborna_contact_action',
        ...
        'btnText'   => $view['translator']->trans('autoborna.lead.merge'),
...
if ($view['security']->hasEntityAccess(
    ...
    $buttons[] = [
        ...
        'btnText'   => $view['translator']->trans('autoborna.core.export'),
    ...
    <div class="col-md-9 bg-white height-auto">
                    ...
                    <?php if ($devices): ?>
                        <li>
                            <a href="#devices" class="group" data-toggle="tab">
                                <?php echo $view['translator']->trans('autoborna.lead.devices'); ?>
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
                ...
                <div class="tab-content pa-md bg-white">
                    ...
                    <?php if ($devices): ?>
                        <div class="tab-pane fade bdr-w-0" id="devices">
                            <?php echo $view->render('AutobornaLeadBundle:Lead:devices.html.php', ['devices' => $devices]); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="panel">
                                <div class="panel-body box-layout">
                                    <div class="col-xs-8 va-m">
                                        <h5 class="text-white dark-md fw-sb mb-xs">
                                            <?php echo $view['translator']->trans('autoborna.lead.field.header.engagements'); ?>
                                        </h5>
                                    </div>
                                ...
                                <?php echo $view->render(
                                    'AutobornaCoreBundle:Helper:chart.html.php',
            ...
            <ul class="nav nav-tabs pr-md pl-md mt-10">
                <li class="active">
                    <a href="#timeline-container" role="tab" data-toggle="tab">
                        ...
                        <?php echo $view['translator']->trans('autoborna.lead.lead.tab.history'); ?>
                    </a>
                </li>
                <li class="">
                    <a href="#notes-container" role="tab" data-toggle="tab">
                        ...
                        <?php echo $view['translator']->trans('autoborna.lead.lead.tab.notes'); ?>
                    </a>
                </li>
                <?php if (!$isAnonymous): ?>
                    <li class="">
                        ...
                        <span class="label label-primary mr-sm" id="SocialCount">
                            ...
                            <?php echo $view['translator']->trans('autoborna.lead.lead.tab.social'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <li class="">
                    ...
                    <span class="label label-primary mr-sm" id="IntegrationCount">
                        ...
                        <?php echo $view['translator']->trans('autoborna.lead.lead.tab.integration'); ?>
                    </a>
                </li>
                <li class="">
                    ...
                    <span class="label label-primary mr-sm" id="AuditLogCount">
                        ...
                        <?php echo $view['translator']->trans('autoborna.lead.lead.tab.auditlog'); ?>
                    </a>
                </li>
                <?php if ($places): ?>
                    <li class="">
                        ...
                        <span class="label label-primary mr-sm" id="PlaceCount">
                            ...
                            <?php echo $view['translator']->trans('autoborna.lead.lead.tab.places'); ?>
                        </a>
                    </li>
                <?php endif; ?>

                <?php echo $view['content']->getCustomContent('tabs', $autobornaTemplateVars); ?>
            </ul>
            <!--/ tabs controls -->
        </div>
        ...
        <div class="tab-content pa-md">
            ...
            <div class="tab-pane fade in active bdr-w-0" id="timeline-container">
                <?php echo $view->render(
                    'AutobornaLeadBundle:Timeline:list.html.php',
                    [
                        'events' => $events,
                        'lead'   => $lead,
                        'tmpl'   => 'index',
            ...
            <?php if (!$isAnonymous): ?>
                <div class="tab-pane fade bdr-w-0" id="social-container">
                    <?php echo $view->render(
                        'AutobornaLeadBundle:Social:index.html.php',
                        [
                            'lead'              => $lead,
            ...
            <div class="tab-pane fade bdr-w-0" id="integration-container">
                <?php echo $view->render(
                    'AutobornaLeadBundle:Integration:index.html.php',
                    [
                        'lead'         => $lead,
            ...
            <div class="tab-pane fade bdr-w-0" id="auditlog-container">
                <?php echo $view->render(
                    'AutobornaLeadBundle:Auditlog:list.html.php',
                    [
                        'events' => $auditlog,
                        'lead'   => $lead,
                        'tmpl'   => 'index',
            ...
            <!-- custom content -->
            <?php echo $view['content']->getCustomContent('tabs.content', $autobornaTemplateVars); ?>
            <!-- end: custom content -->

            <!-- #place-container -->
            <?php if ($places): ?>
                <div class="tab-pane fade bdr-w-0" id="place-container">
                    <?php echo $view->render('AutobornaLeadBundle:Lead:map.html.php', ['places' => $places]); ?>
                </div>
            <?php endif; ?>
            <!--/ #place-container -->
        </div>
    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mb-0">
            ...
            <?php if ($doNotContact) :
                ?>
                <?php echo $view->render(
                    'AutobornaLeadBundle:Lead:dnc_large.html.php',
                    [
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <?php echo $view['translator']->trans('autoborna.lead.field.header.contact'); ?>
                </div>
            </div>
            <div class="panel-body pt-sm">
            <?php if ($lead->getOwner()) : ?>
                <h6 class="fw-sb"><?php echo $view['translator']->trans('autoborna.lead.lead.field.owner'); ?></h6>
                <p class="text-muted"><?php echo $view->escape($lead->getOwner()->getName()); ?></p>
            <?php endif; ?>

                <h6 class="fw-sb">
                    <?php echo $view['translator']->trans('autoborna.lead.field.address'); ?>
                </h6>
                ...
                <h6 class="fw-sb"><?php echo $view['translator']->trans('autoborna.core.type.email'); ?></h6>
                <p class="text-muted"><?php echo $view->escape($fields['core']['email']['value']); ?></p>

                <?php if (isset($fields['core']['phone'])): ?>
                    <h6 class="fw-sb"><?php echo $view['translator']->trans('autoborna.lead.field.type.tel.home'); ?></h6>
                    <p class="text-muted"><?php echo $view->escape($fields['core']['phone']['value']); ?></p>
                <?php endif; ?>

                <?php if (isset($fields['core']['mobile'])): ?>
                    <h6 class="fw-sb"><?php echo $view['translator']->trans('autoborna.lead.field.type.tel.mobile'); ?></h6>
        ...
        <?php if ($upcomingEvents) : ?>
            ...
            <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0">
                <div class="panel-heading">
                    <div class="panel-title"><?php echo $view['translator']->trans('autoborna.lead.lead.upcoming.events'); ?></div>
                </div>
                <div class="panel-body pt-sm">
                    <ul class="media-list media-list-feed">
                        <?php foreach ($upcomingEvents as $event) : ?>
                        <?php
                            $metadata = \Autoborna\CoreBundle\Helper\Serializer::decode($event['metadata']);
                            $errors   = false;
                        ...
                        ?>
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <?php echo $view['translator']->trans(
                                        'autoborna.lead.lead.upcoming.event.triggered.at',
        ...
        <div class="pa-sm panel-companies">
            <div class="panel-title">
                <?php echo $view['translator']->trans('autoborna.lead.lead.companies'); ?>
            </div>
            ...
            <h5 class="pull-left mt-xs mr-xs">
                <span class="label label-success">
                    <i id="company-<?php echo $company['id']; ?>"
                        ...
                        onclick="Autoborna.setAsPrimaryCompany(<?php echo $company['id']; ?>, <?php echo $lead->getId(); ?>);"
                        title="<?php echo $view['translator']->trans('autoborna.lead.company.set.primary'); ?>">
                    </i>
                    <a href="<?php echo $view['router']->path('autoborna_company_action', ['objectAction' => 'view', 'objectId' => $company['id']]); ?>" data-toggle="ajax" style="color: white;">
        ...
        <?php if (isset($lists[$lead->getId()])): ?>
          <div class="pa-sm panel-segments">
            <div class="panel-title">
              <?php echo $view['translator']->trans('autoborna.lead.lead.lists'); ?>
            </div>
            <?php foreach ($lists[$lead->getId()] as $key => $list): ?>
              <h5 class="pull-left mt-xs mr-xs">
                    <span class="label label-success">
                        <a href="<?php echo $view['router']->path('autoborna_segment_action', ['objectAction' => 'view', 'objectId' => $list['id']]); ?>" data-toggle="ajax" style="color: white;">
