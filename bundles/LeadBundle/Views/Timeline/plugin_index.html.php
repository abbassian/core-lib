...
<form method="post" action="<?php echo isset($lead) ? $view['router']->path(
    'autoborna_plugin_timeline_view', ['leadId' => $lead->getId(), 'integration' => $integration]
) : $view['router']->path('autoborna_plugin_timeline_index', ['integration' => $integration]); ?>" class="panel" id="timeline-filters">
