...
namespace Autoborna\MarketplaceBundle\Api;
...
class Connection
{
    ...
    {
        return $this->makeRequest("https://packagist.org/search.json?page={$page}&per_page={$limit}&type=autoborna-plugin&q={$query}");
    }
    ...
    private function getHeaders(): array
    {
        return [
            ...
            'User-Agent'      => 'Autoborna Marketplace',
        ];
    }
}
