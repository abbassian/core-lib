...
{
    public const NAME = 'autoborna:marketplace:install';
    ...
    protected function configure(): void
    {
        ...
        $this->addArgument('package', InputArgument::REQUIRED, 'The Packagist package to install (e.g. autoborna/example-plugin)');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (empty($package->packageBase->type) || 'autoborna-plugin' !== $package->packageBase->type) {
            throw new Exception('Package type is not autoborna-plugin. Cannot install this plugin.');
        }
