...
namespace Autoborna\MarketplaceBundle\Command;
...
{
    public const NAME = 'autoborna:marketplace:remove';
    ...
    protected function configure(): void
    {
        ...
        $this->addArgument('package', InputArgument::REQUIRED, 'The Packagist package of the plugin to remove (e.g. autoborna/example-plugin)');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!in_array($packageVendorAndName, $this->composer->getAutobornaPluginPackages())) {
            $output->writeln('This package cannot be removed, it must be of type autoborna-plugin');
