...
class Stat
{
    ...
    /**
     * @var \Autoborna\LeadBundle\Entity\LeadList
     */
    private $list;
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('push_notification_stats')
            ->setCustomRepositoryClass('Autoborna\NotificationBundle\Entity\StatRepository')
        ...
        $builder->createManyToOne('list', 'Autoborna\LeadBundle\Entity\LeadList')
    ...
    /**
     * @return \Autoborna\LeadBundle\Entity\LeadList
     */
