...
class NotificationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.notification.form.internal.name',
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'autoborna.notification.form.internal.description',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => ['class' => 'form-control'],
                'required'   => false,
            ]
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.notification.form.heading',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => ['class' => 'form-control'],
                'required'   => false,
            ]
        ...
        $builder->add(
            ...
            TextareaType::class,
            [
                'label'      => 'autoborna.notification.form.message',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class' => 'form-control',
                    'rows'  => 6,
        ...
        $builder->add(
            ...
            UrlType::class,
            [
                'label'      => 'autoborna.notification.form.url',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.notification.form.url.tooltip',
                ],
                'required' => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.notification.form.button',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.notification.form.button.tooltip',
                ],
                'required' => false,
            ]
        );
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            [
                'data_class' => 'Autoborna\NotificationBundle\Entity\Notification',
            ]
        );
