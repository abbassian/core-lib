...
namespace Autoborna\NotificationBundle\Model;
...
use Autoborna\NotificationBundle\Form\Type\MobileNotificationType;
use Autoborna\NotificationBundle\Form\Type\NotificationType;
...
class NotificationModel extends FormModel implements AjaxLookupModelInterface
{
     ...
     * {@inheritdoc}
     *
     * @return \Autoborna\NotificationBundle\Entity\NotificationRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('AutobornaNotificationBundle:Notification');
    }

    /**
     * @return \Autoborna\NotificationBundle\Entity\StatRepository
     */
    public function getStatRepository()
    {
        return $this->em->getRepository('AutobornaNotificationBundle:Stat');
    }
    ...
    public function getHitsLineChartData($unit, \DateTime $dateFrom, \DateTime $dateTo, $dateFormat = null, $filter = [], $canViewOthers = true)
    {
        ...
        if (!$flag || 'total_and_unique' === $flag) {
            ...
            $chart->setDataset($this->translator->trans('autoborna.notification.show.total.sent'), $data);
        }
