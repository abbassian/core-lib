 ...
 */
if ('index' == $tmpl) {
    $view->extend('AutobornaNotificationBundle:MobileNotification:index.html.php');
}
                        ...
                        $customButtons = [
                            [
                                'attr' => [
                                    ...
                                    'data-header' => $view['translator']->trans('autoborna.notification.mobile_notification.header.preview'),
                                    'data-footer' => 'false',
                                ...
                                'btnText'   => $view['translator']->trans('autoborna.mobile_notification.preview'),
                    ...
                    <td class="visible-sm visible-md visible-lg col-stats">
                        <span class="mt-xs label label-warning has-click-event clickable-stat"
                            ...
                            <a href="<?php echo $view['router']->path(
                                ...
                                ['search' => $view['translator']->trans('autoborna.lead.lead.searchcommand.mobile_sent').':'.$item->getId()]
    ...
    <div class="panel-footer">
        <?php echo $view->render(
            ...
            [
                ...
                'page'       => $page,
                'limit'      => $limit,
                'baseUrl'    => $view['router']->path('autoborna_mobile_notification_index'),
                'sessionVar' => 'mobile_notification',
            ]
        ); ?>
    </div>
