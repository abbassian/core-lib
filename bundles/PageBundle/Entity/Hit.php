...
class Hit
{
    ...
    /**
     * @var \Autoborna\EmailBundle\Entity\Email
     */
    private $email;
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('page_hits')
            ->setCustomRepositoryClass('Autoborna\PageBundle\Entity\HitRepository')
        ...
        $builder->createManyToOne('email', 'Autoborna\EmailBundle\Entity\Email')
        ...
        $builder->createManyToOne('device', 'Autoborna\LeadBundle\Entity\LeadDevice')
     ...
     * @return Hit
     */
    public function setIpAddress(\Autoborna\CoreBundle\Entity\IpAddress $ipAddress)
    {
