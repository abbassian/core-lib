...
class PageRepository extends CommonRepository
{
    ...
    protected function addSearchCommandWhereClause($q, $filter)
    {
        ...
        switch ($command) {
            ...
            case $this->translator->trans('autoborna.core.searchcommand.lang', [], null, 'en_US'):
                ...
                break;
            case $this->translator->trans('autoborna.page.searchcommand.isprefcenter'):
            case $this->translator->trans('autoborna.page.searchcommand.isprefcenter', [], null, 'en_US'):
    ...
    public function getSearchCommands()
    {
        $commands = [
            ...
            'autoborna.page.searchcommand.isprefcenter',
        ];
