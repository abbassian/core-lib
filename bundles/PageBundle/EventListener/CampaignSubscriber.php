...
use Autoborna\PageBundle\Form\Type\CampaignEventPageHitType;
use Autoborna\PageBundle\Form\Type\TrackingPixelSendType;
...
class CampaignSubscriber implements EventSubscriberInterface
{
    ...
    public function onCampaignBuild(CampaignBuilderEvent $event)
    {
        //Add trigger
        $pageHitTrigger = [
            'label'          => 'autoborna.page.campaign.event.pagehit',
            'description'    => 'autoborna.page.campaign.event.pagehit_descr',
        ...
        //Add trigger
        $deviceHitTrigger = [
            'label'          => 'autoborna.page.campaign.event.devicehit',
            'description'    => 'autoborna.page.campaign.event.devicehit_descr',
        ...
        if (!empty($trackingServices)) {
            $action = [
                'label'                  => 'autoborna.page.tracking.pixel.event.send',
                'description'            => 'autoborna.page.tracking.pixel.event.send_desc',
