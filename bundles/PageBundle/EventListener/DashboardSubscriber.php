...
use Autoborna\PageBundle\Form\Type\DashboardHitsInTimeWidgetType;
            ...
            if (!$event->isCached()) {
                ...
                if ($pages) {
                    foreach ($pages as &$page) {
                        $pageUrl = $this->router->generate('autoborna_page_action', ['objectAction' => 'view', 'objectId' => $page['id']]);
                        $row     = [
                            [
                                'value' => $page['title'],
                                'type'  => 'link',
                ...
                $event->setTemplateData([
                    'headItems' => [
                        ...
                        'autoborna.dashboard.label.hits',
                    ],
                    'bodyItems' => $items,
                    'raw'       => $pages,
                ]);
