...
class ReportSubscriber implements EventSubscriberInterface
{
    ...
    public function onReportBuilder(ReportBuilderEvent $event)
    {
        ...
        $columns = [
            ...
            $prefix.'revision' => [
                'label' => 'autoborna.page.report.revision',
                'type'  => 'string',
            ],
            $prefix.'hits' => [
                'label' => 'autoborna.page.field.hits',
                'type'  => 'int',
            ],
            $prefix.'unique_hits' => [
                'label' => 'autoborna.page.field.unique_hits',
                'type'  => 'int',
            ],
            $translationPrefix.'id' => [
                'label' => 'autoborna.page.report.translation_parent_id',
                'type'  => 'int',
            ],
            $translationPrefix.'title' => [
                'label' => 'autoborna.page.report.translation_parent_title',
                'type'  => 'string',
            ],
            $variantPrefix.'id' => [
                'label' => 'autoborna.page.report.variant_parent_id',
                'type'  => 'string',
            ],
            $variantPrefix.'title' => [
                'label' => 'autoborna.page.report.variant_parent_title',
                'type'  => 'string',
            ],
            $prefix.'lang' => [
            ...
            $prefix.'variant_start_date' => [
                'label'          => 'autoborna.page.report.variant_start_date',
                'type'           => 'datetime',
                'groupByFormula' => 'DATE('.$prefix.'variant_start_date)',
            ],
            $prefix.'variant_hits' => [
                'label' => 'autoborna.page.report.variant_hits',
                'type'  => 'int',
            ],
        ];
        $columns = array_merge(
            $columns,
            $event->getStandardColumns('p.', ['name', 'description'], 'autoborna_page_action'),
            $event->getCategoryColumns()
        );
        $data = [
            'display_name' => 'autoborna.page.pages',
            'columns'      => $columns,
        ];
        ...
        if ($event->checkContext(self::CONTEXT_PAGE_HITS)) {
            ...
            $hitColumns  = [
                $hitPrefix.'id' => [
                    'label' => 'autoborna.page.report.hits.id',
                    'type'  => 'int',
                ],
                $hitPrefix.'date_hit' => [
                    'label'          => 'autoborna.page.report.hits.date_hit',
                    'type'           => 'datetime',
                    'groupByFormula' => 'DATE('.$hitPrefix.'date_hit)',
                ],
                $hitPrefix.'date_left' => [
                    'label'          => 'autoborna.page.report.hits.date_left',
                    'type'           => 'datetime',
                    'groupByFormula' => 'DATE('.$hitPrefix.'date_left)',
                ],
                $hitPrefix.'country' => [
                    'label' => 'autoborna.page.report.hits.country',
                    'type'  => 'string',
                ],
                $hitPrefix.'region' => [
                    'label' => 'autoborna.page.report.hits.region',
                    'type'  => 'string',
                ],
                $hitPrefix.'city' => [
                    'label' => 'autoborna.page.report.hits.city',
                    'type'  => 'string',
                ],
                $hitPrefix.'isp' => [
                    'label' => 'autoborna.page.report.hits.isp',
                    'type'  => 'string',
                ],
                $hitPrefix.'organization' => [
                    'label' => 'autoborna.page.report.hits.organization',
                    'type'  => 'string',
                ],
                $hitPrefix.'code' => [
                    'label' => 'autoborna.page.report.hits.code',
                    'type'  => 'int',
                ],
                $hitPrefix.'referer' => [
                    'label' => 'autoborna.page.report.hits.referer',
                    'type'  => 'string',
                ],
                $hitPrefix.'url' => [
                    'label' => 'autoborna.page.report.hits.url',
                    'type'  => 'url',
                ],
                $hitPrefix.'url_title' => [
                    'label' => 'autoborna.page.report.hits.url_title',
                    'type'  => 'string',
                ],
                $hitPrefix.'user_agent' => [
                    'label' => 'autoborna.page.report.hits.user_agent',
                    'type'  => 'string',
                ],
                $hitPrefix.'remote_host' => [
                    'label' => 'autoborna.page.report.hits.remote_host',
                    'type'  => 'string',
                ],
                $hitPrefix.'browser_languages' => [
                    'label' => 'autoborna.page.report.hits.browser_languages',
                    'type'  => 'array',
                ],
                $hitPrefix.'source' => [
                ...
                $redirectHit.'url' => [
                    'label' => 'autoborna.page.report.hits.redirect_url',
                    'type'  => 'url',
                ],
                $redirectHit.'hits' => [
                    'label' => 'autoborna.page.report.hits.redirect_hit_count',
                    'type'  => 'int',
                ],
                $redirectHit.'unique_hits' => [
                    'label' => 'autoborna.page.report.hits.redirect_unique_hits',
                    'type'  => 'string',
                ],
                'ds.device' => [
                    'label' => 'autoborna.lead.device',
                    'type'  => 'string',
                ],
                'ds.device_brand' => [
                    'label' => 'autoborna.lead.device_brand',
                    'type'  => 'string',
                ],
                'ds.device_model' => [
                    'label' => 'autoborna.lead.device_model',
                    'type'  => 'string',
                ],
                'ds.device_os_name' => [
                    'label' => 'autoborna.lead.device_os_name',
                    'type'  => 'string',
                ],
                'ds.device_os_shortname' => [
                    'label' => 'autoborna.lead.device_os_shortname',
                    'type'  => 'string',
                ],
                'ds.device_os_version' => [
                    'label' => 'autoborna.lead.device_os_version',
                    'type'  => 'string',
                ],
                'ds.device_os_platform' => [
                    'label' => 'autoborna.lead.device_os_platform',
                    'type'  => 'string',
                ],
            ];
            ...
            $data = [
                'display_name' => 'autoborna.page.hits',
            ...
            $event->addGraph($context, 'line', 'autoborna.page.graph.line.time.on.site');
            $event->addGraph($context, 'pie', 'autoborna.page.graph.pie.time.on.site', ['translate' => false]);
            $event->addGraph($context, 'pie', 'autoborna.page.graph.pie.new.vs.returning');
            $event->addGraph($context, 'pie', 'autoborna.page.graph.pie.devices');
            $event->addGraph($context, 'pie', 'autoborna.page.graph.pie.languages', ['translate' => false]);
            $event->addGraph($context, 'table', 'autoborna.page.table.referrers');
            $event->addGraph($context, 'table', 'autoborna.page.table.most.visited');
            $event->addGraph($context, 'table', 'autoborna.page.table.most.visited.unique');
        }
        if ($event->checkContext(self::CONTEXT_VIDEO_HITS)) {
            ...
            $hitColumns = [
                ...
                'time_watched' => [
                    'label'   => 'autoborna.page.report.hits.time_watched',
                    'type'    => 'string',
                    'formula' => 'if('.$hitPrefix.'duration = 0,\'-\',SEC_TO_TIME('.$hitPrefix.'time_watched))',
                ],
                'duration' => [
                    'label'   => 'autoborna.page.report.hits.duration',
                    'type'    => 'string',
            ...
            $data = [
                'display_name' => 'autoborna.'.self::CONTEXT_VIDEO_HITS,
    ...
    public function onReportGraphGenerate(ReportGraphEvent $event)
    {
        ...
        foreach ($graphs as $g) {
            ...
            switch ($g) {
                ...
                case 'autoborna.page.graph.line.time.on.site':
                    $chart = new LineChart(null, $options['dateFrom'], $options['dateTo']);
                ...
                case 'autoborna.page.graph.pie.time.on.site':
                ...
                case 'autoborna.page.graph.pie.new.vs.returning':
                    $chart   = new PieChart();
                    ...
                    $chart->setDataset($this->translator->trans('autoborna.page.unique'), $unique);
                    $chart->setDataset($this->translator->trans('autoborna.page.graph.pie.new.vs.returning.returning'), $returning);
                ...
                case 'autoborna.page.graph.pie.languages':
                    ...
                    break;
                case 'autoborna.page.graph.pie.devices':
                    ...
                    foreach ($data as $device) {
                        $label = substr(empty($device['device']) ? $this->translator->trans('autoborna.core.no.info') : $device['device'], 0, 12);
                    ...
                    break;
                case 'autoborna.page.table.referrers':
                    $limit                  = 10;
                    $offset                 = 0;
                ...
                case 'autoborna.page.table.most.visited':
                    $limit                  = 10;
                    $offset                 = 0;
                    ...
                    $graphData['link']      = 'autoborna_page_action';
                    $event->setGraph($g, $graphData);
                    break;

                case 'autoborna.page.table.most.visited.unique':
                    $limit                  = 10;
                    $offset                 = 0;
