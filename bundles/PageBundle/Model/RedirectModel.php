...
class RedirectModel extends FormModel
{
     ...
     * {@inheritdoc}
     *
     * @return \Autoborna\PageBundle\Entity\RedirectRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('AutobornaPageBundle:Redirect');
    }
    ...
    /**
     * Generate a Autoborna redirect/passthrough URL.
     *
     ...
     *
     * Use Autoborna\PageBundle\Model\TrackableModel::getTrackableByUrl() if associated with a channel
     *
     * @param  $url
     *
     * @return Redirect|null
