...
use Autoborna\PageBundle\Event\UntrackableUrlsEvent;
...
class TrackableModel extends AbstractCommonModel
{
     ...
     * {@inheritdoc}
     *
     * @return \Autoborna\PageBundle\Entity\TrackableRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('AutobornaPageBundle:Trackable');
    }
    ...
    protected function extractTrackablesFromHtml($html)
    {
        ...
        foreach ($links as $link) {
            ...
            if ($link->hasAttribute('autoborna:disable-tracking')) {
