...
use Autoborna\PageBundle\DataFixtures\ORM\LoadPageData;
use Autoborna\PageBundle\Entity\Page;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\Response;

class PageControllerTest extends AutobornaMysqlTestCase
{
    use ControllerTrait;
    ...
    protected function setUp(): void
    {
        ...
        $model = self::$container->get('autoborna.page.model.page');
        $page  = new Page();
    ...
    public function testLandingPageWithUtmTracking(): void
    {
        ...
        $this->client->request('GET', "{$page->getAlias()}?utm_source=linkedin&utm_medium=social&utm_campaign=autoborna&utm_content=".$timestamp);
        ...
        if (Response::HTTP_OK === $clientResponse->getStatusCode()) {
            ...
            foreach ($allUtmTags as $utmTag) {
                ...
                $this->assertSame('autoborna', $utmTag->getUtmCampaign(), 'utm_campaign does not match');
