...
namespace Autoborna\PageBundle\Tests\Controller;
...
use Autoborna\PageBundle\Controller\PublicController;
...
class PublicControllerTest extends AutobornaMysqlTestCase
{
    ...
    private function getVariantContent($aCount, $bCount, $cCount)
    {
        ...
        $autobornaSecurity = $this->getMockBuilder(CorePermissions::class)
            ->disableOriginalConstructor()
            ->getMock();
        $autobornaSecurity->method('hasEntityAccess')
            ->will($this->returnValue(false));
        ...
        $container->method('get')
            ->will(
                $this->returnValueMap(
                    [
                        ['autoborna.helper.cookie', Container::EXCEPTION_ON_INVALID_REFERENCE, $cookieHelper],
                        ['templating.helper.assets', Container::EXCEPTION_ON_INVALID_REFERENCE, $assetHelper],
                        ['autoborna.helper.ip_lookup', Container::EXCEPTION_ON_INVALID_REFERENCE, $ipHelper],
                        ['autoborna.security', Container::EXCEPTION_ON_INVALID_REFERENCE, $autobornaSecurity],
                        ['autoborna.helper.template.analytics', Container::EXCEPTION_ON_INVALID_REFERENCE, $analyticsHelper],
                        ['autoborna.page.model.page', Container::EXCEPTION_ON_INVALID_REFERENCE, $pageModel],
                        ['autoborna.lead.model.lead', Container::EXCEPTION_ON_INVALID_REFERENCE, $leadModel],
                        ...
                        ['autoborna.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $modelFactory],
                    ]
                )
            );
    ...
    public function testThatInvalidClickTroughGetsProcessed(): void
    {
        ...
        $this->internalContainer
            ->method('get')
            ->willReturnMap([
                ['monolog.logger.autoborna', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->logger],
                ['autoborna.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->modelFactory],
                ['autoborna.helper.ip_lookup', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->ipLookupHelper],
                ['autoborna.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->modelFactory],
                ['autoborna.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->modelFactory],
                ['autoborna.lead.helper.primary_company', Container::EXCEPTION_ON_INVALID_REFERENCE, $this->primaryCompanyHelper],
    ...
    /**
     * @covers \Autoborna\PageBundle\Event\TrackingEvent::getContact
     * @covers \Autoborna\PageBundle\Event\TrackingEvent::getResponse
     * @covers \Autoborna\PageBundle\Event\TrackingEvent::getRequest
     *
     * @throws \Exception
     */
    public function testMtcTrackingEvent()
    {
        ...
        $container->method('get')
            ->will(
                $this->returnValueMap(
                    [
                        ['autoborna.security', Container::EXCEPTION_ON_INVALID_REFERENCE, $security],
                        ['autoborna.model.factory', Container::EXCEPTION_ON_INVALID_REFERENCE, $modelFactory],
                        ['autoborna.page.model.page', Container::EXCEPTION_ON_INVALID_REFERENCE, $pageModel],
                        ['autoborna.lead.service.device_tracking_service', Container::EXCEPTION_ON_INVALID_REFERENCE, $deviceTrackingService],
                        ['autoborna.page.helper.tracking', Container::EXCEPTION_ON_INVALID_REFERENCE, $trackingHelper],
    ...
    {
        $this->client->request('GET', '/mtracking.gif?url=http%3A%2F%2Fautoborna.org');
