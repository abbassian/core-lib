...
use Autoborna\PageBundle\EventListener\ReportSubscriber;
...
class ReportSubscriberTest extends TestCase
{
    ...
    public function testOnReportGraphGenerate(): void
    {
        ...
        $mockEvent->expects($this->once())
            ...
            ->willReturn(
                [
                    'autoborna.page.graph.line.hits',
                    'autoborna.page.graph.line.time.on.site',
                    'autoborna.page.graph.pie.time.on.site',
                    'autoborna.page.graph.pie.new.vs.returning',
                    'autoborna.page.graph.pie.languages',
                    'autoborna.page.graph.pie.devices',
                    'autoborna.page.table.referrers',
                    'autoborna.page.table.most.visited',
                    'autoborna.page.table.most.visited.unique',
                ]
            );
