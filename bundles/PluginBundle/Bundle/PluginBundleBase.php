...
namespace Autoborna\PluginBundle\Bundle;
...
abstract class PluginBundleBase extends Bundle
{
     ...
     * @throws \Exception
     */
    public static function installPluginSchema(array $metadata, AutobornaFactory $factory, $installedSchema = null)
    {
     ...
     * @throws \Exception
     */
    public static function updatePluginSchema(array $metadata, Schema $installedSchema, AutobornaFactory $factory)
    {
        $db         = $factory->getDatabase();
        $schemaTool = new SchemaTool($factory->getEntityManager());
     ...
     * @param null $metadata
     */
    public static function onPluginUninstall(Plugin $plugin, AutobornaFactory $factory, $metadata = null)
    {
    }
     ...
     * @throws \Exception
     */
    public static function dropPluginSchema(array $metadata, AutobornaFactory $factory)
    {
        $db          = $factory->getDatabase();
        $schemaTool  = new SchemaTool($factory->getEntityManager());
