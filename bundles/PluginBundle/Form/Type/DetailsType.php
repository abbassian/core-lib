    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
                ...
                $builder->add(
                    ...
                    [
                        'attr'     => [
                            ...
                            'onclick' => 'Autoborna.initiateIntegrationAuthorization()',
                            'icon'    => 'fa fa-key',
                        ],
                        'label'    => 'autoborna.integration.form.'.$label,
                        'disabled' => $disabled,
                    ]
                );
            }
        ...
        if (!empty($features)) {
            ...
            foreach ($features as $f) {
                $choices['autoborna.integration.form.feature.'.$f] = $f;
            }
            ...
            $builder->add(
                ...
                [
                    ...
                    'multiple'    => true,
                    'label'       => 'autoborna.integration.form.features',
                    'required'    => false,
                    'data'        => $data,
        ...
        $builder->add(
            ...
            [
                'label'              => 'autoborna.integration.form.feature.settings',
                'required'           => true,
