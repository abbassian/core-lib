        ...
        if (!empty($options['campaigns'])) {
            $builder->add(
                ...
                [
                    ...
                    'attr'    => [
                        'class' => 'form-control', 'onchange' => 'Autoborna.getIntegrationCampaignStatus(this);', ],
                    'label'             => 'autoborna.plugin.integration.campaigns',
                    'placeholder'       => 'autoborna.plugin.config.campaign.member.chooseone',
                    'required'          => false,
                    ]
            );
        }
