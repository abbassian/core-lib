...
namespace Autoborna\PointBundle\Controller\Api;
...
class PointApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->entityClass      = 'Autoborna\PointBundle\Entity\Point';
    ...
    protected function logApiPointChange($lead, $delta, $operator)
    {
        ...
        $ip         = $this->get('autoborna.helper.ip_lookup')->getIpAddress();
        $eventName  = InputHelper::clean($this->request->request->get('eventName', $trans->trans('autoborna.lead.lead.submitaction.operator_'.$operator)));
        $actionName = InputHelper::clean($this->request->request->get('actionName', $trans->trans('autoborna.lead.event.api')));
