...
$header = ($entity->getId()) ?
    $view['translator']->trans('autoborna.point.trigger.header.edit',
        ['%name%' => $view['translator']->trans($entity->getName())]) :
    $view['translator']->trans('autoborna.point.trigger.header.new');
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <ul class="bg-auto nav nav-tabs pr-md pl-md">
                    <li class="active"><a href="#details-container" role="tab" data-toggle="tab"><?php echo $view['translator']->trans('autoborna.core.details'); ?></a></li>
                    <li class=""><a href="#events-container" role="tab" data-toggle="tab"><?php echo $view['translator']->trans('autoborna.point.trigger.tab.events'); ?></a></li>
                </ul>
                <!--/ tabs controls -->
                ...
                <div class="tab-content pa-md">
                    ...
                    <div class="tab-pane fade bdr-w-0" id="events-container">
                        <div id="triggerEvents">
                            <div class="mb-md">
                                <p><?php echo $view['translator']->trans('autoborna.point.trigger.addevent'); ?></p>
                                <div class="dropdown">
                                    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
                                        <?php echo $view['translator']->trans('autoborna.point.trigger.event.add'); ?>
                                        ...
                                        <?php foreach ($events as $group => $event): ?>
                                            ...
                                            <?php foreach ($event as $k => $e): ?>
                                                <li id="event_<?php echo $k; ?>">
                                                    <a data-toggle="ajaxmodal" data-target="#triggerEventModal" class="list-group-item" href="<?php echo $view['router']->path('autoborna_pointtriggerevent_action', ['objectAction' => 'new', 'type' => $k, 'tmpl' => 'event', 'triggerId' => $sessionId]); ?>">
                            ...
                            foreach ($triggerEvents as $event):
                                $template = (isset($event['settings']['template'])) ? $event['settings']['template'] :
                                    'AutobornaPointBundle:Event:generic.html.php';
...
<?php echo $view['form']->end($form); ?>
 ...
 <?php
    $view['slots']->append('modal', $view->render('AutobornaCoreBundle:Helper:modal.html.php', [
        ...
        'header'        => $view['translator']->trans('autoborna.point.trigger.form.modalheader'),
        'footerButtons' => true,
    ]));
?>
