...
return [
    'services' => [
        'events' => [
            'autoborna.queue.rabbitmq.subscriber' => [
                'class'     => \Autoborna\QueueBundle\EventListener\RabbitMqSubscriber::class,
                'arguments' => 'service_container',
            ],
            'autoborna.queue.beanstalkd.subscriber' => [
                'class'     => \Autoborna\QueueBundle\EventListener\BeanstalkdSubscriber::class,
                'arguments' => [
                    'service_container',
        ...
        'other' => [
            'autoborna.queue.service' => [
                'class'     => \Autoborna\QueueBundle\Queue\QueueService::class,
                'arguments' => [
            ...
            'autoborna.queue.helper.rabbitmq_consumer' => [
                'class'     => \Autoborna\QueueBundle\Helper\RabbitMqConsumer::class,
                'arguments' => 'autoborna.queue.service',
            ],
        ],
    ],
    'parameters' => [
        ...
        // The work queue/message broker must be configured and running outside of Autoborna for this to function.
