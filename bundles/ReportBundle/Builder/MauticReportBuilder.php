...
namespace Autoborna\ReportBundle\Builder;
...
final class AutobornaReportBuilder implements ReportBuilderInterface
{
    /**
     * @var array
     */
    const OPERATORS = [
        'default' => [
            ...
            'gt'         => 'autoborna.core.operator.greaterthan',
            'gte'        => 'autoborna.core.operator.greaterthanequals',
            'lt'         => 'autoborna.core.operator.lessthan',
            'lte'        => 'autoborna.core.operator.lessthanequals',
            'neq'        => 'autoborna.core.operator.notequals',
            'like'       => 'autoborna.core.operator.islike',
            'notLike'    => 'autoborna.core.operator.isnotlike',
            'empty'      => 'autoborna.core.operator.isempty',
            'notEmpty'   => 'autoborna.core.operator.isnotempty',
            'contains'   => 'autoborna.core.operator.contains',
            'startsWith' => 'autoborna.core.operator.starts.with',
            'endsWith'   => 'autoborna.core.operator.ends.with',
        ],
        'bool' => [
            'eq'  => 'autoborna.core.operator.equals',
            'neq' => 'autoborna.core.operator.notequals',
        ...
        'multiselect' => [
            'in'    => 'autoborna.core.operator.in',
            'notIn' => 'autoborna.core.operator.notin',
        ],
        'select' => [
            'eq'  => 'autoborna.core.operator.equals',
            'neq' => 'autoborna.core.operator.notequals',
