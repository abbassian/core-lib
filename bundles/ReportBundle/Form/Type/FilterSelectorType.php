    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $formModifier = function (FormInterface $form, $column) use ($options) {
            ...
            $form->add(
                ...
                [
                    ...
                    'expanded'          => false,
                    'multiple'          => false,
                    'label'             => 'autoborna.report.report.label.filtercondition',
        ...
        $builder->add(
            ...
            [
                ...
                'required'          => false,
                'choices'           => [
                    'autoborna.report.report.glue.choice.and' => 'and',
                    'autoborna.report.report.glue.choice.or'  => 'or',
                ],
                'placeholder' => false,
            ]
        );
        ...
        $builder->add(
            ...
            TextType::class,
            [
                'label'      => 'autoborna.report.report.label.filtervalue',
                'label_attr' => ['class' => 'control-label'],
        ...
        $builder->add(
            ...
            [
                'label'      => 'autoborna.report.report.label.filterdynamic',
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'class'   => 'form-control',
                    'tooltip' => 'autoborna.report.report.label.filterdynamic_tooltip',
                ],
                'required' => false,
            ]
        );
