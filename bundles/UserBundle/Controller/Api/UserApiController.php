...
class UserApiController extends CommonApiController
{
    ...
    public function initialize(FilterControllerEvent $event)
    {
        ...
        $this->entityClass      = 'Autoborna\UserBundle\Entity\User';
    ...
    public function editEntityAction($id)
    {
        ...
        if (null === $entity) {
            if ('PATCH' === $method ||
                ('PUT' === $method && !$this->get('autoborna.security')->isGranted('user:users:create'))
            ) {
    ...
    public function isGrantedAction($id)
    {
        ...
        if (empty($permissions)) {
            return $this->badRequest('autoborna.api.call.permissionempty');
        } elseif (!is_array($permissions)) {
            $permissions = [$permissions];
        }

        $return = $this->get('autoborna.security')->isGranted($permissions, 'RETURN_ARRAY', $entity);
