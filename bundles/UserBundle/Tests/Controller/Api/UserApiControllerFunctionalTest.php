...
namespace Autoborna\UserBundle\Tests\Controller\Api;
...
class UserApiControllerFunctionalTest extends AutobornaMysqlTestCase
{
    ...
    public function testRoleUpdateByApiGivesErrorResponseIfUserDoesNotHaveValidPermissionToUpdate(): void
    {
        ...
        $this->client->setServerParameter('PHP_AUTH_PW', 'autoborna');
    ...
    private function createUser(Role $role): User
    {
        ...
        $user->setPassword($encoder->encodePassword('autoborna', null));
        $user->setRole($role);
