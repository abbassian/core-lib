...
namespace Autoborna\UserBundle\Tests\Security\Firewall;

use Doctrine\ORM\EntityManagerInterface;
use Doctrine\Persistence\ObjectRepository;
use FOS\OAuthServerBundle\Security\Authentication\Token\OAuthToken;
use Autoborna\ApiBundle\Entity\oAuth2\AccessToken;
...
use Autoborna\UserBundle\Security\Authentication\AuthenticationHandler;
use Autoborna\UserBundle\Security\Firewall\AuthenticationListener;
