...
use Autoborna\WebhookBundle\Command\ProcessWebhookQueuesCommand;
...
class WebhookFunctionalTest extends AutobornaMysqlTestCase
{
    ...
    public function testWebhookWorkflowWithCommandProcess()
    {
        $httpClient                        = new class() extends Client {
            ...
            public function sendRequest(RequestInterface $request): ResponseInterface
            {
                ...
                Assert::assertCount(3, $jsonPayload['autoborna.lead_post_save_new']);
        ...
        self::$container->set('autoborna.guzzle.client', $httpClient);
    ...
    private function createWebhook(): Webhook
    {
        ...
        $event->setEventType('autoborna.lead_post_save_new');
