...
namespace Autoborna\WebhookBundle\Tests\Helper;
...
class CampaignHelperTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->contact->expects($this->once())
            ...
            ->willReturn(['email' => 'john@doe.email', 'company' => 'Autoborna']);
    ...
    {
        $expectedUrl = 'https://autoborna.org?test=tee&email=john%40doe.email&IP=127.0.0.1%2C127.0.0.2';

        $this->client->expects($this->once())
            ->method('get')
            ->with($expectedUrl, [
                \GuzzleHttp\RequestOptions::HEADERS => ['test' => 'tee', 'company' => 'Autoborna'],
