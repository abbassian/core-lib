...
// This is loaded by \Autoborna\CoreBundle\DependencyInjection\AutobornaCoreExtension to auto-wire Commands
...
return function (ContainerConfigurator $configurator) {
    ...
    $services->load('Autoborna\\', '../bundles/*/Command/*');
    $services->load('AutobornaPlugin\\', '../../plugins/*/Command/*');
};
