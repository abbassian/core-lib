 ...
 */
final class Version20191219155630 extends AbstractAutobornaMigration
{
    ...
    public function up(Schema $schema): void
    {
        if (!$schema->hasTable($this->prefix.'sync_object_field_change_report')) {
            $this->addSql(
                "# Dump of table autoborna_sync_object_field_change_report
            # ------------------------------------------------------------
        ...
        if (!$schema->hasTable($this->prefix.'sync_object_mapping')) {
            $this->addSql(
                "# Dump of table autoborna_sync_object_mapping
            # ------------------------------------------------------------
